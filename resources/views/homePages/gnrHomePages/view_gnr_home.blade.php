...
<div class="row">
	...
	<div class="col-md-10 fullbody">
		<div class="">
			{{-- <h2 class="panel-title configure text-secondary">Configuration Dashboard</h2> --}}
...
$(document).ready(function(){
	...
	$("#loadTab1").load('{{URL::to("gnr/loadgnrTab1")}}');

    $("#tab2a").click(function(){
    	$("#loadTab2").html(loadingDiv);
    	$("#loadTab2").load('{{URL::to("gnr/loadgnrTab2")}}');
	});

    $("#tab3a").click(function(){
    	$("#loadTab3").html(loadingDiv);
    	$("#loadTab3").load('{{URL::to("gnr/loadgnrTab3")}}');
	});

    $("#tab4a").click(function(){
    	$("#loadTab4").html(loadingDiv);
    	$("#loadTab4").load('{{URL::to("gnr/loadgnrTab4")}}');
	});
