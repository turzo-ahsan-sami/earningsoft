...
@section('content')
@section('title', '| Inventory Home')
{{-- <link rel="stylesheet" href="{{ asset('../resources/views/homePages/invHomePages/invHome.css') }}"> --}}
...
$(document).ready(function(){
	...
	$("#loadTab1").load('{{URL::to("inv/loadInvTab1")}}');

    $("#tab2a").click(function(){
    	$("#loadTab2").html(loadingDiv);
    	$("#loadTab2").load('{{URL::to("inv/loadInvTab2")}}');
	});

    $("#tab3a").click(function(){
    	$("#loadTab3").html(loadingDiv);
    	$("#loadTab3").load('{{URL::to("inv/loadInvTab3")}}');
	});
