...
{{-- <link rel="stylesheet" href="{{ asset('../resources/views/homePages/posHomePages/invHome.css') }}"> --}}
...
<div class="row">
	...
	<div class="col-md-10 fullbody">
		<div class="">
        	...
        	<!-- <img src="{{ asset('software/images/dashboards/invDashboard/invDashboard.png') }}"> -->
        {{-- 	<h2 class="panel-title configure text-secondary">Billing Dashboard</h2> --}}
    	</div>
        				...
        				<ul class="nav nav-tabs">
							...
							<li>
								<a id="tab3a" href="#tab3" data-toggle="tab">
									<span class=""><i class="fa fa-line-chart"></i></span>
...
$(document).ready(function(){
	...
	$("#loadTab1").load('{{URL::to("pos/loadPosTab1")}}');

    $("#tab2a").click(function(){
    	$("#loadTab2").html(loadingDiv);
    	$("#loadTab2").load('{{URL::to("pos/loadPosTab2")}}');
	});

    $("#tab3a").click(function(){
    	$("#loadTab3").html(loadingDiv);
    	$("#loadTab3").load('{{URL::to("pos/loadPosTab3")}}');
	});
