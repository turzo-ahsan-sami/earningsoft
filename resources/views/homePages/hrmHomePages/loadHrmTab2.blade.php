		...
		<div class="row glance_container">
			...
			<div class="col-md-12">
				<div style="" class="listing_big_image blue_bg animated fadeInLeft">
	            	<img src="{{ asset('images/dashboards/accDashboard/surplus.png') }}" border="0" width="50px" height="50px">
		...
		<div class="row glance_container">
			...
			<div class="col-md-12">
				<div style="" class="listing_big_image blue_bg animated fadeInDown">
	            	<img src="{{asset('images/dashboards/accDashboard/openingBalance.png')}}" border="0" width="50px" height="50px">
