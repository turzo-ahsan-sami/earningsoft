...
<div class="row">
	...
	<div class="col-md-10 fullbody">
		<div class="viewTitle">
			<span class="panel-title" style="color: white; font-size:40px;">General Settings</span>
        	{{-- <img src="{{ asset('software/images/dashboards/accDashboard/accDashboard.png') }}"> --}}
    	</div>
        				...
        				<ul class="nav nav-tabs">
							...
							<li>
								<a id="tab3a" href="#tab3" data-toggle="tab">
									<span class=""><i class="fa-user"></i></span>
									<span class="hidden-xs">Emploee</span>
								</a>
							</li>
							{{-- <li>
...
$(document).ready(function(){
	...
	$("#loadTab1").load('{{URL::to("acc/loadAccTab1")}}');

    $("#tab2a").click(function(){
    	$("#loadTab2").html(loadingDiv);
    	$("#loadTab2").load('{{URL::to("acc/loadAccTab2")}}');
	});

    $("#tab3a").click(function(){
    	$("#loadTab3").html(loadingDiv);
    	$("#loadTab3").load('{{URL::to("acc/loadAccTab3")}}');
	});

    $("#tab4a").click(function(){
    	$("#loadTab4").html(loadingDiv);
    	$("#loadTab4").load('{{URL::to("acc/loadAccTab4")}}');
	});
