...
<div class="row">
    <div class="col-md-12">
        <div class="" style="">
                    ...
                    <div class="panel-heading" style="padding-bottom:0px">
                        ...
                        <div class="row" id="filtering-group">
                            ...
                            <div class="form-horizontal form-groups" style="padding-right: 0px;">
                                ...
                                {!! Form::open(['url' => 'famsFixedAssetsSalesReport','method' => 'get']) !!}
                                @php
            ...
            <h2 align="center" style="font-family: Antiqua;letter-spacing: 2px; color: white;margin-top: 0px;">Fixed Assets Sales Report</h2>
            ...
            <div id="printDiv">
                <div id="printingContent">
                    <div style="display: none;text-align: center;" id="hiddenTitle">
                     ...
                     <h4 style="text-align: center;padding: 0px;margin: 0px;">Fixed Assets Sales Report</h4>                          
...
<table id="famsAssetTransferReportTable" class="table table-striped table-bordered" style="color:black;font-size:11px;margin-bottom:50px;border-collapse: collapse;" width="100%" border= "1px solid white;" cellpadding="0" cellspacing="0">
    <thead>
        <tr>
            ...
            <th rowspan="1" colspan="3" style="border-bottom-width: 0px;">Product Value</th>
            <th rowspan="2" >Sales Amount</th>
            <th rowspan="1" colspan="2" style="border-bottom-width: 0px;">Profit & Loss</th>                                            
        </tr>
        <tr>
            <th >Cost Price</th>
            <th >Acc. Dep.</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align: center;">{{date('d-m-Y',strtotime($sale->createdDate))}}</td>
            <td style="text-align: left;padding-left: 5px;">{{$productName}}</td>

            <td style="text-align: center;">{{$prefix.$productCode}}</td>                                      


            <td style="text-align: right;padding-right: 5px;">{{number_format($sale->productTotalCost,2)}}</td>
            <td style="text-align: right;padding-right: 5px;">{{number_format($sale->depGenerated,2)}}</td>
            <td style="text-align: right;padding-right: 5px;">{{number_format($sale->productTotalCost - $sale->depGenerated,2)}}</td>

            <td style="text-align: right;padding-right: 5px;">{{number_format($sale->amount,2)}}</td>
            @php $totalSalesAmount = $totalSalesAmount + $sale->amount; @endphp

            <td style="text-align: right;padding-right: 5px;">{{number_format($sale->profitAmount,2)}}</td>
            <td style="text-align: right;padding-right: 5px;">{{number_format($sale->lossAmount,2)}}</td>
        ...
        <tr class="totalRow">
            ...
            <td style="text-align: right;padding-right: 5px;font-weight: bold;">{{number_format($totalSalesAmount,2)}}</td>                                                
  ...
  $(document).ready(function() {
     ...
     $(document).ready(function() {
      ...
      today = dd+'-'+mm+'-'+yyyy;
        ...
        let a = $("<a />", {
          href: url,
          download: "Fixed Assets Sales Report_"+ today + ".xls"}).appendTo("body").get(0).click();
        e.preventDefault();
    });
...
<style type="text/css">
#famsAssetTransferReportTable thead tr th {
