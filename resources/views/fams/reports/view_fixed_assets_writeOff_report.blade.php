...
<div class="row">
    <div class="col-md-12">
        <div class="" style="">
                    ...
                    <div class="panel-heading" style="padding-bottom:0px">
                        ...
                        <div class="row" id="filtering-group">
                            ...
                            <div class="form-horizontal form-groups" style="padding-right: 0px;">
                                ...
                                {!! Form::open(['url' => 'famsFixedAssetsWtiteOffReport','method' => 'get']) !!}
                                @php
            ...
            <h2 align="center" style="font-family: Antiqua;letter-spacing: 2px; color: white;margin-top: 0px;">Fixed Assets Write Off Report</h2>
            ...
            <div id="printDiv">
                <div id="printingContent">
                    <div style="display: none;text-align: center;" id="hiddenTitle">
                       ...
                       <h4 style="text-align: center;padding: 0px;margin: 0px;">Fixed Assets Write Off Report</h4>                          
...
<table id="famsAssetTransferReportTable" class="table table-striped table-bordered" style="color:black;font-size:11px;margin-bottom:50px;border-collapse: collapse;" width="100%" border= "1px solid black;" cellpadding="0" cellspacing="0">
    <thead>
        <tr>
            <th rowspan="2" width="60">SL#</th>
            <th rowspan="2" >Write Off Date</th>
            <th rowspan="2" >Product Name</th>
            <th rowspan="2" >Product ID</th>
            <th rowspan="1" colspan="3" style="border-bottom-width: 0px;">Product Value</th>
            <th rowspan="2" >Disposal Amount</th>                                                  
    ...
    <tbody>
        ...
        @foreach($writeOffs as $key => $writeOff)
        ...
        <tr>
            ...
            <td style="text-align: center;">{{date('d-m-Y',strtotime($writeOff->createdDate))}}</td>
            <td style="text-align: left;padding-left: 5px;">{{$productName}}</td>

            <td style="text-align: center;">{{$prefix.$productCode}}</td>                                      


            <td style="text-align: right;padding-right: 5px;">{{number_format($writeOff->productTotalCost,2)}}</td>
            <td style="text-align: right;padding-right: 5px;">{{number_format($writeOff->depGenerated,2)}}</td>
            <td style="text-align: right;padding-right: 5px;">{{number_format($writeOff->lossAmount,2)}}</td>
            <td style="text-align: right;padding-right: 5px;">{{number_format($writeOff->lossAmount,2)}}</td>
            <td style="text-align: right;padding-right: 5px;">{{number_format($writeOff->productTotalCost,2)}}</td>
            @php
            $totalDisposalAmount = $totalDisposalAmount + $writeOff->lossAmount;
            $totalAdjustmentAmount = $totalAdjustmentAmount + $writeOff->productTotalCost;
            @endphp
        ...
        <tr class="totalRow">
            ...
            <td style="text-align: right;padding-right: 5px;font-weight: bold;">{{number_format($totalDisposalAmount,2)}}</td> 

            <td style="text-align: right;padding-right: 5px;font-weight: bold;">{{number_format($totalAdjustmentAmount,2)}}</td>
  ...
  $(document).ready(function() {
     ...
     $(document).ready(function() {
      ...
      today = dd+'-'+mm+'-'+yyyy;
        ...
        let a = $("<a />", {
          href: url,
          download: "Fixed Assets Write Off Report_"+ today + ".xls"}).appendTo("body").get(0).click();
        e.preventDefault();
    });
