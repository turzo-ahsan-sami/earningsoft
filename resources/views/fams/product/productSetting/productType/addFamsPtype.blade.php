            ...
            <div class="col-md-2"></div>
                <div class="col-md-8 fullbody">
                    <div class="viewTitle" style="border-bottom: 1px solid white;">
                        <a href="{{url('viewFamsPtype/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-th-list viewIcon">
                            ...
                            {!! Form::open(array('url' => '', 'role' => 'form', 'class'=>'form-horizontal form-groups')) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            {!! Form::text('productTypeCode', $value = null, ['class' => 'form-control', 'id' => 'productTypeCode', 'type' => 'text', 'placeholder' => 'Enter Product Type Code']) !!}
                                            <p id='productTypeCodee' style="max-height:3px;"></p>
                                        </div>
                                    </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 text-right">
                                        ...
                                        <a href="{{url('viewFamsPtype/')}}" class="btn btn-danger closeBtn">Close</a>
    ...
    if (_response.errors) {
        if (_response.errors['name']) {
            ...
            if (_response.errors['productTypeCode']) {
                $('#productTypeCodee').empty();
                $('#productTypeCodee').show();
                $('#productTypeCodee').append('<span class="errormsg" style="color:red;">'+_response.errors.productTypeCode+'</span>');
                //return false;
            }
...
$("input").keyup(function(){
    ...
    if(productTypeCode){$('#productTypeCodee').hide();}else{$('#productTypeCodee').show();}
...
$("#productTypeCode").on('input',function () {
