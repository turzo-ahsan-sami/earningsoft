        ...
        <div class="col-md-2"></div>
            <div class="col-md-8 fullbody">
                <div class="viewTitle" style="border-bottom: 1px solid white;">
                    <a href="{{url('viewFamsPsize/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-th-list viewIcon">
                    </i>Size List</a>
                </div>
                <div class="panel panel-default panel-border">
                    ...
                    {!! Form::open(array('url' => '', 'role' => 'form', 'class'=>'form-horizontal form-groups')) !!}
                        ...
                        <div class="form-group">
                            {!! Form::label('name', 'Size Name:', ['class' => 'col-sm-3 control-label']) !!}
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 text-right">
                                ...
                                <a href="{{url('viewFamsPsize/')}}" class="btn btn-danger closeBtn">Close</a>
...
<script type="text/javascript">
    ...
    if (_response.errors) {
            ...
            window.location.href = '{{url('viewFamsPsize/')}}';
            }
        },
