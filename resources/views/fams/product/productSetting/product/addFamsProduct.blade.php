            ...
            <div class="col-md-10 fullbody">
                ...
                <div class="panel panel-default panel-border">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(array('url' => 'storeFamsProduct' ,'id'=>'form', 'enctype' => 'multipart/form-data',  'role' => 'form', 'class'=>'form-horizontal form-groups')) !!}
...
<script>
    $(document).ready(function () {
        ...
        var prefix = "{{$prefix}}";
        var text = prefix+"00000-00-0000-000-0000-000-0000";
        key = "AmbalaAsset";
        var csrf = "<?php echo csrf_token(); ?>";
        $.ajax({
            type: 'post',
        ...
        function calculateDep() {
            if(($("#usefulLifeYear").val()!="" || $("#usefulLifeMonth").val()!="") && $("#total").val()!=""){
                ...
                if(($("#usefulLifeYear").val()=="" || $("#usefulLifeYear").val()==0) && ($("#usefulLifeMonth").val()=="" || $("#usefulLifeMonth").val()==0)){
