        ...
        <div class="col-md-2"></div>
            <div class="col-md-8 fullbody">
                <div class="viewTitle" style="border-bottom: 1px solid white;">
                    <a href="{{url('viewFamsPsubCtg/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-th-list viewIcon">
                    </i>Product Subcategory List</a>
                </div>
                <div class="panel panel-default panel-border">
                        <div class="panel-heading">
                            <div class="panel-title">Product Subcategory</div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Form::open(array('url' => '', 'role' => 'form', 'class'=>'form-horizontal form-groups')) !!}
                                    ...
                                    <div class="form-group">
                                        {!! Form::label('subCategoryCode', 'Sub Catagory Code:', ['class' => 'col-sm-3 control-label']) !!}
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group pull-right">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <a href="{{url('viewFamsPsubCtg/')}}" class="btn btn-danger closeBtn">Close</a>
...
$('form').submit(function( event ) {
    ...
    if (_response.errors) {
            ...
            if (_response.errors['subCategoryCode']) {
                $('#subCategoryCodee').empty();
                $('#subCategoryCodee').show();
                $('#subCategoryCodee').append('<span class="errormsg" style="color:red;">'+_response.errors.subCategoryCode+'</span>');
                return false;
            }
            ...
            window.location.href = '{{url('viewFamsPsubCtg/')}}';
            }
        },
...
$("input").keyup(function(){
    ...
    if(subCategoryCode){$('#subCategoryCodee').hide();}else{$('#subCategoryCodee').show();} */        
    });
...
$("#productGroupId").change(function(){
    ...
    $.ajax({
        type: 'post',
        url: './FamsPgroupIdSend',//productBrandController
        data: $('form').serialize(),
        dataType: 'json',   
        success: function( _response ){
...
$("#subCategoryCode").on('input', function() {
