            ...
            <div class="col-md-2"></div>
                <div class="col-md-8 fullbody">
                    <div class="viewTitle" style="border-bottom: 1px solid white;">
                        <a href="{{url('famsAdditionalProduct/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-th-list viewIcon">
                        </i>Product Group List</a>
                    </div>
                <div class="panel panel-default panel-border">
                                <div class="panel-heading">
                                    <div class="panel-title">Additional Product</div>
                                </div>
                                    ...
                                    {!! Form::open(array('url' => '', 'role' => 'form', 'class'=>'form-horizontal form-groups')) !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <p id='categorye' style="max-height:3px;"></p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('submit', ' ', ['class' => 'col-sm-3 control-label']) !!}
                                            <div class="col-sm-9 text-right">
                                                {!! Form::button('Submit', ['id' => 'save', 'class' => 'btn btn-info','type'=>'button']); !!}
                                                <a href="{{url('famsAdditionalProduct/')}}" class="btn btn-danger closeBtn">Close</a>
                        ...
                        success: function( _response ){
                            ...
                            if(_response.errors){
                                ...
                                if (_response.errors['categoryId']) {
                                    $("#categorye").empty();
                                    $("#categorye").append('<span class="errormsg" style="color:red;">'+_response.errors.categoryId+'</span>');
                                }
                            }
                            else{
