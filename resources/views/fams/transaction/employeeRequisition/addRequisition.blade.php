            ...
            <div class="col-md-1"></div>
                <div class="col-md-10 fullbody">
                    <div class="viewTitle" style="border-bottom: 1px solid white;">
                        <a href="{{url('viewFamsEmpRequiItem/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-th-list viewIcon">
                    ...
                    {!! Form::open(array('url' => '', 'role' => 'form',  'class'=>'form-horizontal form-groups')) !!}
                     ...
                     <div class="col-md-6">     
                         <div class="form-group">
                            ...
                            <div class="col-sm-8">
                               <?php 
                                    $requisitionMaxId = DB::table('fams_employee_requisition')->where('branchId',$gnrBranchId)->count()+1;
                                    $valueForField = 'RE'.sprintf('%04d', $gnrBranchId) . sprintf('%06d', $requisitionMaxId);
                                ?>
                    ...
                    <div class="col-md-6"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 text-right" style="">
                                ...
                                <a href="{{url('viewFamsEmpRequiItem/')}}" class="btn btn-danger closeBtn">Close</a>
...
$('form').submit(function( event ) {
    ...
    $.ajax({
        ...
        //alert(JSON.stringify(_response));
            ...
            window.location.href = '{{url('viewFamsEmpRequiItem/')}}';
        },
