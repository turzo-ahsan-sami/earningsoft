      ...
      <div class="panel panel-default" style="background-color:#708090;">
        <div class="panel-heading"  style="padding-bottom:0px">
          <div class="panel-options">
              <a href="{{url('addFamsBrnRequiF/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-plus-sign addIcon"></i>Add Requisition</a>
          </div>
        </div>
        ...
        <div>
          ...
          {
            /*$("#famsBraReqView").dataTable().yadcf([
    
            ]);*/
            $("#famsBraReqView").dataTable({
                   "oLanguage": {
          ...
          <table class="table table-striped table-bordered" id="famsBraReqView">
            <thead>
              <tr>
                <th width="32">SL#</th>
                <th>Date</th>
                  ...
                  @foreach($requisitions as $requisition)
                    <tr class="item{{$requisition->id}}">
                      ...
                      <td class="text-center" width="80">
                        ...
                        <a id="editIcone" href="javascript:;" class="edit-modal" data-id="{{$requisition->id}}" data-requisitionno="{{$requisition->requisitionNo}}" data-branchid="{{$grnBranchId}}" data-requisitionto="{{$requisition->requisitionTo}}" data-totalquantity="{{$requisition->totalQuantity}}"  data-totalamount="{{$requisition->totalAmount}}" data-slno="{{$no}}">
...
@include('fams/transaction/branchRequisition/requisitionDetails')
...
$.ajax({
        ...
        $('.item' + data["updateDatas"][0].id).replaceWith(
                                    "<tr class='item" + data["updateDatas"][0].id + "'><td  class='text-center slNo'>" + data.slno +
                                                                    ...
                                                                    "</td><td style='text-align: left;'>" + data["requisitiontTo"].name +
