    		...
    		<div class="col-md-2"></div>
    			<div class="col-md-8 fullbody">
    				<div class="viewTitle" style="border-bottom: 1px solid white;">
            			<a href="{{url('viewFamsUseReturn/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-th-list viewIcon">
            			</i>Use Return List</a>
        			</div>
                    ...
                    {!! Form::open(array('url' => '', 'role' => 'form',  'class'=>'form-horizontal form-groups', 'id' => 'useReturnForm')) !!}
                     ...
                     <div class="col-md-10">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-8">
                               <?php 
									$useMaxId = DB::table('fams_tra_use_return')->max('id')+1;
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-8 text-right" style="">
								...
								<a href="{{url('viewFamsUseReturn/')}}" class="btn btn-danger closeBtn">Close</a>
							</div>
						</div>
...
$('form').submit(function( event ) {
    ...
    $.ajax({
        ...
        //alert(JSON.stringify(_response));
			...
			window.location.href = '{{url('viewFamsUseReturn/')}}';
        },
