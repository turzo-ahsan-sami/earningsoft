      ...
      <div class="panel panel-default" style="background-color:#708090;">
        <div class="panel-heading"  style="padding-bottom:0px">
          <div class="panel-options">
              <a href="{{url('addFamsUseReturn/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-plus-sign addIcon"></i>Add Use Return</a>
          </div>
          <h1 align="center" style="font-family: Antiqua;letter-spacing: 2px; color: white;">USE RETURN LIST</h1>
        </div>
                  ...
                  <div class="col-md-1"></div>
                    <div class="col-md-10">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <?php 
									             $useBillNo = array('' => 'Please Select')+DB::table('fams_tra_use')->where('branchId',$grnBranchId)->pluck('useBillNo','id')->all(); 
								              ?>
...
$("#useBillNo").change(function(){ 
                     ...
                     $.each(data, function (key, value) {
                     	if(key == 'products'){
                     		...
                     		$.each(value, function(key1, value1){
                     			$('#productId').append("<option value='"+ value1.id+"'>"+value1.productCode+"</option>"); 
                     		});	
                     	}
                     });
		...
		$("#productId").change(function(){ 
              ...
              $.ajax({
                  type: 'post',
                  url: './getProQtyFrmFamsUseDetailsTable',
	...
	$('#addProductTable tbody .forEmpty').remove();
			...
			$.ajax({
                  ...
                  success: function( data ){
                    ...
                    $.each(data, function (key, value) {
                          $('#productId').append("<option value='"+ value.id+"'>"+value.productCode+"</option>"); 
                    });
                },
                error: function(data){
                  alert("error");
...
$.each(data, function (key, value) {
			...
			if (key == "productId") {
				$.each(value, function (key1, value1) {
					//alert(value1.id);
				$('.apendSelectOption').append("<option value='"+ value1.id+"'>"+value1.productCode+"</option>");
