<style type="text/css">
	...
	#useDetailsModel .table-bordered > thead > tr > th, 
	#useDetailsModel .table-bordered > tbody > tr > th, 
	#useDetailsModel .table-bordered > tfoot > tr > th, 
	#useDetailsModel .table-bordered > thead > tr > td, 
	#useDetailsModel .table-bordered > tbody > tr > td, 
	#useDetailsModel .table-bordered > tfoot > tr > td {
	    line-height: 1.42857;
    	padding: 8px;
...
<div class="modal-dialog">
	<div class="modal-content">
		<div style="text-align: center;" class="modal-header">
			...
			<h4 class="modal-title" id="useDetailsHead">Use Details</h4>
		<div style="padding-top: 10px;">	
		<p>
			<span style="margin-bottom: 0px">Use Bill No : </span>
			<span style="margin-bottom: 0px"><span id="useBillnoHead"></span></span>
		</p>
		<p>
			<span style="margin-top: 0px;margin-bottom: 0px">Requisition No : </span>
			<span style="margin-top: 0px;margin-bottom: 0px"><span id="useRequisitionHead"></span></span>
		</p>	
		<p>
			<span style="margin-top: 0px" id="">Branch Name : </h5>
			<span style="margin-top: 0px;margin-bottom: 0px"><span id="useBranchHead"></span></span>
		</p>
		<p>
			<span style="margin-top: 0px;margin-bottom: 0px"  id="useEmployeeHeadLabel"> </span>
			<span style="margin-top: 0px;margin-bottom: 0px"><span id="useEmployeeHead"></span></span>
		</p>
		<p id="useDepartmentHeadP" style="display: none;">
			<span style="margin-top: 0px;margin-bottom: 0px"  id="useDepartmentHeadLabel"> </span>
			<span style="margin-top: 0px;margin-bottom: 0px"><span id="useDepartmentHead"></span></span>
		</p>
		<p>
			<span style="margin-top: 0px;margin-bottom: 0px"  id="">Use Date : </span>
			<span style="margin-top: 0px;margin-bottom: 0px"><span id="useDateHead"></span></span>
		</p>	
		</div>
		</div>
		<div class="modal-body">
			<div class="row">
				<div class="col-md-12">
							...
							<a class="list-group-item active">Use Bill No: <span id="showUsebillNo"></span></a>
						    ...
						    <thead>
							    ...
							    <tr>
							    	<th width="80"><span style="background-color: white; padding: 4px 15px;">Qty</span></th>
