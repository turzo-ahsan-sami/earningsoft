            ...
            <div class="col-md-1"></div>
                <div class="col-md-10 fullbody">
                    <div class="viewTitle" style="border-bottom: 1px solid white;">
                        <a href="{{url('viewInvEmpRequiItem/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-th-list viewIcon">
                        </i>Requisition List</a>
                    </div>
                <div class="panel panel-default panel-border">
                                <div class="panel-heading">
                                    <div class="panel-title">Employee Requisition</div>
                                </div>
                    ...
                    {!! Form::open(array('url' => '', 'role' => 'form',  'class'=>'form-horizontal form-groups')) !!}
                     ...
                     <div class="col-md-6">     
                         <div class="form-group">
                            ...
                            <div class="col-sm-8">
                               <?php 
                                    $requisitionMaxId = DB::table('inv_employee_requisition')->where('branchId',$gnrBranchId)->count()+1;
                    ...
                    <div class="col-md-6"> 
                        <div class="form-group">
                            {!! Form::label('employeeId', 'Employee:', ['class' => 'col-sm-4 control-label']) !!}
                            <div class="col-sm-8">
                            <?php 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <p id='totalQuantitye' style="max-height:3px;"></p>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 text-right" style="">
                                ...
                                <a href="{{url('viewInvEmpRequiItem/')}}" class="btn btn-danger closeBtn">Close</a>
...
$('form').submit(function( event ) {
    ...
    $.ajax({
        ...
        success: function( _response ){
            ...
            if (_response.errors['totalQuantity']) {
                $('#totalQuantitye').empty();
                $('#totalQuantitye').append('<span class="errormsg" style="color:red;">'+_response.errors.totalQuantity+'</span>');
                return false;
            }
        }
            window.location.href = '{{url('viewInvEmpRequiItem/')}}';
        },
