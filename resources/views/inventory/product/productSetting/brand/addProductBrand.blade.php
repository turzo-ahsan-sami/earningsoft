        ...
        <div class="col-md-2"></div>
            <div class="col-md-8 fullbody">
                <div class="viewTitle" style="border-bottom: 1px solid white;">
                    <a href="{{url('viewProductBrand/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-th-list viewIcon">
                    ...
                    {!! Form::open(array('url' => '', 'role' => 'form', 'class'=>'form-horizontal form-groups')) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <a href="{{url('viewProductBrand/')}}" class="btn btn-danger closeBtn">Close</a>
...
$('form').submit(function( event ) {
    ...
    if (_response.errors) {
            ...
            window.location.href = '{{url('viewProductBrand/')}}';
            }
        },
