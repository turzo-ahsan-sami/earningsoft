...
@php
  $foreignBrandIds = DB::table('inv_product')->distinct()->pluck('brandId')->toArray();
@endphp
      ...
      <div class="panel panel-default" style="background-color:#708090;">
        <div class="panel-heading" style="padding-bottom:0px">
          <div class="panel-options">
              <a href="{{url('addProductBrand/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-plus-sign addIcon"></i>Add Brand</a>
          </div>
                  ...
                  @foreach($productBrands as $productBrand)
                    <tr class="item{{$productBrand->id}}">
                      ...
                      <td style="padding-left: 5px; text-align: left;">
                          <?php
                            $productGroupName = DB::table('inv_product_group')->select('name')->where('id',$productBrand->productGroupId)->first();
                          ?>
                          {{$productGroupName->name}}
                      </td>
                      <td style="padding-left: 5px; text-align: left;">
                          <?php
                            $productCategoryName = DB::table('inv_product_category')->select('name')->where('id',$productBrand->productCategoryId)->first();
                          ?>
                          {{$productCategoryName->name}}
                      </td>
                      <td style="padding-left: 5px; text-align: left;">
                          <?php
                            $productSubCategoryName = DB::table('inv_product_sub_category')->select('name')->where('id',$productBrand->productSubCategoryId)->first();
                          ?>
