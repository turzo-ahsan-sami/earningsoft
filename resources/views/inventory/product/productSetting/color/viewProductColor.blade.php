...
@php
  $foreignColorIds = DB::table('inv_product')->distinct()->pluck('colorId')->toArray(); 
@endphp
      ...
      <div class="panel panel-default" style="background-color:#708090;">
        <div class="panel-heading" style="padding-bottom:0px">
          <div class="panel-options">
             <a href="{{url('addProductColor/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-plus-sign addIcon"></i>Add Color</a>
          </div>
                    ...
                    @foreach($productColors as $productColor)
                      <tr class="item{{$productColor->id}}">
                        ...
                        <td style="padding-left: 5px; text-align: left;">
                            <?php
                              $productGroupName = DB::table('inv_product_group')->select('name')->where('id',$productColor->productGroupId)->first();
                            ?>
                            {{$productGroupName->name}}
                        </td>
                        <td style="padding-left: 5px; text-align: left;">
                            <?php
                              $productCategoryName = DB::table('inv_product_category')->select('name')->where('id',$productColor->productCategoryId)->first();
                            ?>
                            {{$productCategoryName->name}}
                        </td>
                        <td style="padding-left: 5px; text-align: left;">
                            <?php
                              $productSubCategoryName = DB::table('inv_product_sub_category')->select('name')->where('id',$productColor->productSubCategoryId)->first();
                            ?>
                            {{$productSubCategoryName->name}}
                        </td>
                        <td style="padding-left: 5px; text-align: left;">
                            <?php
                              $productBrandName = DB::table('inv_product_brand')->select('name')->where('id',$productColor->productBrandId)->first();
                            ?>
                            {{$productBrandName->name}}
                        </td>
                        <td style="padding-left: 5px; text-align: left;">
                            <?php
                              $productModelName = DB::table('inv_product_model')->select('name')->where('id',$productColor->productModelId)->first();
                            ?>
                            {{$productModelName->name}}
                        </td>
                        <td style="padding-left: 5px; text-align: left;">
                            <?php
                              $productSizeName = DB::table('inv_product_size')->select('name')->where('id',$productColor->productSizeId)->first();
                            ?>
...
$(document).on('click', '.edit-modal', function() {
  if(hasAccess('editProductColorItem')){
    $('.errormsg').empty();
    $('#MSGE').empty();
    $('#MSGS').empty();
...
$(document).on('click', '.delete-modal', function() {
  if(hasAccess('deleteProductColorItem')){
  $('#MSGE').empty();
  $('#MSGS').empty();
