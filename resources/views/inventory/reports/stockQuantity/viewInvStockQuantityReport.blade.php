    ...
    <div id="printDiv">
        <div id="printView">
            <div class="text-center">
                ...
                <span style="color: black; font-weight: bold">Stock Report</span><br>
            ...
            <table class="table table-striped table-bordered" id="stockViewTable" border="1pt solid ash" style="color:black; border-collapse: collapse;">
                <thead>
                  <tr>
                    ...
                    <th class="reportPgTh">Current Stock Qty</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td >
                    ...
                    if($gnrBranchId==1 || $branchName=='Head Office'){
                        ...
                        $openingAmount = $InvProduct->costPrice;
                    }
                    $totalopeningQuantity += $openingStock;
             ...
             <td >
                ...
                ?>
                {{ number_format($purchaseReturnQty) }}
            </td>
            <td >
             <?php
...
<tr>
    ...
    <td style="background-color: white; "><span style="font-size: 12px; font-weight: bold;">{{ $totalopeningQuantity }}</span></td>
    ...
    <td style="background-color: white;text-align: center;"><span style="font-size: 12px; font-weight: bold;">{{ $totalStock }}</span></td>
...
<script type="text/javascript">
    $(function(){
      ...
      $("#btnExportExcel").click(function(e) {
        ...
        let a = $("<a />", {
          href: url,
          download: "Stock Report_"+ today + ".xls"}).appendTo("body").get(0).click();
        e.preventDefault();
    });
