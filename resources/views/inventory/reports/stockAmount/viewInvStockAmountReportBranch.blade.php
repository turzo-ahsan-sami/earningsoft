...
$totalthisBranchGetTrnsfrAmount =0;
$totalthisBranchSendTrnsfrAmount=0;
$totalUseAmount                 =0;
...
<div class="row">
    <div class="" style="">
        ...
        <h3 style="text-align: center; color: white">Branch Stock Amount Report</h3>                 
    </div>
    <div class="panel-body panelBodyView"> 
        ...
        <div class="row">
            <div class="col-md-11">
              ...
              {!! Form::open(array('url' => 'filterStockAmountReportBranch/', 'role' => 'form', 'class'=>'form-horizontal form-groups', 'id' => 'filteringForm', 'method'=>'get')) !!}
    ...
    <div id="printDiv">
        <div id="printView">
            <div class="text-center">
                ...
                <span style="color: black; font-weight: bold">Branch Stock Amount Report</span><br>
...
$totalthisBranchGetTrnsfrAmount += $thisBranchGetTrnsfrAmount;
?>
{{ number_format($thisBranchGetTrnsfrAmount,2) }}
</td>
<td style="text-align: right; padding-right: 5px; ">
   <?php
   if (str_contains(Request::fullUrl(), 'filterStockAmountReportBranch') && $_GET['branchId']){
...
$totalthisBranchSendTrnsfrAmount += $thisBranchSendTrnsfrAmount;                                                
?>
{{ number_format($thisBranchSendTrnsfrAmount,2) }}
</td>
<td style="text-align: right; padding-right: 5px; ">
    <?php
    if (str_contains(Request::fullUrl(), 'filterStockAmountReportBranch') && $_GET['branchId']){
...
<td style="text-align: right; padding-right: 5px; ">  
    <?php
    $stockAmount = (float)($openingAmount+$purchaseAmount+$issueAmount+$thisBranchGetTrnsfrAmount+$useReturnAmount)-
    (float)($purchaseReturnAmount+$issueReturnAmount+$thisBranchSendTrnsfrAmount+$useAmount);
...
<tr>
    ...
    <td class="fotBgColor" style="background-color: white"><span style="font-size: 12px; font-weight: bold;">{{ number_format($totalthisBranchGetTrnsfrAmount,2) }}</span></td>

    <td class="fotBgColor" style="background-color: white"><span style="font-size: 12px; font-weight: bold;">{{ number_format($totalthisBranchSendTrnsfrAmount,2) }}</span></td>
    ...
    <td class="" style="background-color: white"><span style="font-size: 12px; font-weight: bold;">{{ number_format($totalStock) }}</span></td>
...
<script type="text/javascript">
    $(function(){
       ...
       $("#btnExportExcel").click(function(e) {
        ...
        let a = $("<a />", {
          href: url,
          download: "Branch Stock Amount Report_"+ today + ".xls"}).appendTo("body").get(0).click();
        e.preventDefault();
    });
