        ...
        <div class="col-md-10 fullbody">
            ...
            <div class="panel panel-default panel-border">
                <div class="panel-heading">
                    <div class="panel-title">Add Cost Sheet</div>
                </div>
                        ...
                        <div class="col-md-8 col-sm-offset-2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 row">
                                    {!! Form::text('effectDate', '', ['class' => 'form-control', 'id' => 'effectDate', 'type' => 'text','placeholder' => 'Enter date','autocomplete'=>'off','style'=>'padding-right:0px']) !!}
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $('#addRawMaterial').click(function(){
        ...
        {   
            if(jQuery.inArray(rawMaterialId, tempRawProducts) != -1) 
            {
    ...
    $('#addOtherCost').click(function(){
        ...
        {  
            if(jQuery.inArray(otherCostTypeId, tempOtherCostArr) != -1) 
            {
