...
@php
  $categoryIdsFromProductTable = DB::table('pos_product')->distinct()->pluck('categoryId')->toArray();
  $categoryIdsFromSubCategoryTable = DB::table('pos_product_sub_category')->distinct()->pluck('productCategoryId')->toArray();
      ...
      <div class="panel panel-default" style="background-color:#708090;">
        <div class="panel-heading" style="padding-bottom:0px">
          <div class="panel-options">
              <a href="{{url('pos/posAddProductCategory/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-plus-sign addIcon"></i>Add Catagory</a>
          </div>
                            ...
                            @foreach($productCategories as $productCategory)
                              <tr class="item{{$productCategory->id}}">
                                ...
                                <td style="padding-left: 25px; text-align: left;">
                                    <?php
                                      $productGroupName = DB::table('pos_product_group')->select('name')->where('id',$productCategory->productGroupId)->first();
                                    ?>
...
/*  }*/
  ...
  $.ajax({
      type: 'post',
      url: './posEditProductCategoryItem',
      data: $('form').serialize(),
      dataType: 'json',
...
$('.modal-footer').on('click', '.delete', function() {
  $.ajax({
    type: 'post',
    url: './posDeleteProductCategoryItem',
    data: {
