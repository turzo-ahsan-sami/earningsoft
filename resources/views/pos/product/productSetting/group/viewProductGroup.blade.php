...
@php
  $groupIdsFromProductTable = DB::table('pos_product')->distinct()->pluck('groupId')->toArray();
  $groupIdsFromCategoryTable = DB::table('pos_product_category')->distinct()->pluck('productGroupId')->toArray();
      ...
      <div class="panel panel-default" style="background-color:#708090;">
        <div class="panel-heading" style="padding-bottom:0px">
          <div class="panel-options">
              <a href="{{url('pos/posAddProductGroup/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-plus-sign addIcon"></i>Add Product Group</a>
          </div>
