      ...
      <div class="panel panel-default" style="background-color:#708090;">
        <div class="panel-heading" style="padding-bottom:0px">
          <div class="panel-options">
              <a href="{{url('pos/posAddProductSize/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-plus-sign addIcon"></i>Add Size</a>
          </div>
                  ...
                  @foreach($productSizes as $productSize)
                    <tr class="item{{$productSize->id}}">
                      ...
                      <td style="padding-left: 5px; text-align: left;">
                          <?php
                            $productGroupName = DB::table('pos_product_group')->select('name')->where('id',$productSize->productGroupId)->first();
                          ?>
                          {{$productGroupName->name}}
                      </td>
                      <td style="padding-left: 5px; text-align: left;">
                          <?php
                            $productCategoryName = DB::table('pos_product_category')->select('name')->where('id',$productSize->productCategoryId)->first();
                          ?>
                          {{$productCategoryName->name}}
                      </td>
                      <td style="padding-left: 5px; text-align: left;">
                          <?php
                            $productSubCategoryName = DB::table('pos_product_sub_category')->select('name')->where('id',$productSize->productSubCategoryId)->first();
                          ?>
                          {{$productSubCategoryName->name}}
                      </td>
                      <td style="padding-left: 5px; text-align: left;">
                          <?php
                            $productBrandName = DB::table('pos_product_brand')->select('name')->where('id',$productSize->productBrandId)->first();
                          ?>
                          {{$productBrandName->name}}
                      </td>
                      <td style="padding-left: 5px; text-align: left;">
                          <?php
                            $productModelName = DB::table('pos_product_model')->select('name')->where('id',$productSize->productModelId)->first();
                          ?>
                     ...
                     @endphp -->
                      ...
                      <a id="deleteIcone" href="javascript:;" class="delete-modal" data-id="{{$productSize->id}}">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer">
          ...
          <input id="DMproductSizeId" type="hidden" name="houseOwnerReg" value="">
