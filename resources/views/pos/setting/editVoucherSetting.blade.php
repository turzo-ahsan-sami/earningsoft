                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::select('supplier', $accountHeads, $setting->supplier ?? null, ['class' => 'form-control', 'id' => 'supplier', 'type' => 'text', 'placeholder' => 'Select supplier head','autocomplete'=>'off']) !!}
                                        <p style="max-height:3px;">* Account head only</p>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::select('sales', $transactionHeads, $setting->sales ?? null, ['class' => 'form-control', 'id' => 'sales', 'type' => 'text', 'placeholder' => 'Select sales head','autocomplete'=>'off']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::select('salesReturn', $transactionHeads, $setting->sales_return ?? null, ['class' => 'form-control', 'id' => 'sales_return', 'type' => 'text', 'placeholder' => 'Select sales return head','autocomplete'=>'off']) !!}
                                        <p style="max-height:3px;">* Transaction head only</p>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::select('purchase', $transactionHeads, $setting->purchase ?? null, ['class' => 'form-control', 'id' => 'purchase', 'type' => 'text', 'placeholder' => 'Select purchase head','autocomplete'=>'off']) !!}
                                        <p style="max-height:3px;">* Transaction head only</p>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::select('purchaseReturn', $transactionHeads, $setting->purchase_return ?? null, ['class' => 'form-control', 'id' => 'purchase_return', 'type' => 'text', 'placeholder' => 'Select purchase return head','autocomplete'=>'off']) !!}
                                        <p style="max-height:3px;">* Transaction head only</p>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::select('vat', $transactionHeads, $setting->vat ?? null, ['class' => 'form-control', 'id' => 'vat', 'type' => 'text', 'placeholder' => 'Select vat head','autocomplete'=>'off']) !!}
                                        <p style="max-height:3px;">* Transaction head only</p>
                                ...
                                @if($company->business_type != 'manufacture'){
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select('inventory', $transactionHeads, $setting->inventory ?? null, ['class' => 'form-control', 'id' => 'inventory', 'type' => 'text', 'placeholder' => 'Select inventory head','autocomplete'=>'off']) !!}
                                            <p style="max-height:3px;">* Transaction head only</p>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select('cost_of_good_sold', $transactionHeads, $setting->cost_of_good_sold ?? null, ['class' => 'form-control', 'id' => 'cost_of_good_sold', 'type' => 'text', 'placeholder' => 'Select cost of good sold head','autocomplete'=>'off']) !!}
                                            <p style="max-height:3px;">* Transaction head only</p>
