            ...
            <div class="col-md-1"></div>
                <div class="col-md-10 fullbody">
                    <div class="viewTitle" style="border-bottom: 1px solid white;">
                        <a href="{{url('pos/viewPosSalesList/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-th-list viewIcon">
                        </i>Sales List</a>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 text-right" style="">
                                ...
                                <a href="{{url('pos/viewPosSalesList/')}}" class="btn btn-danger closeBtn">Close</a>
...
$('form').submit(function( event ) {
    ...
    $.ajax({
        ...
        //alert(salesId);
            if(!_response.errors){window.location.href = "{{url('pos/salesInvoicePrint/').'/'}}"+salesId;}
