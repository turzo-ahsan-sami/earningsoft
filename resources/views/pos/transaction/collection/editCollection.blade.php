        ...
        <div class="col-md-10 fullbody">
            ...
            <div class="panel panel-default panel-border">
                <div class="panel-heading">
                    <div class="panel-title">Edit Collection</div>
                </div>
                @if(!$setting)
                <div class="panel panel-default panel-border">
                    <div class="panel-heading">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="customer" name="customerId">
                                            ...
                                            @foreach($customers as $customer)
                                                <option value="{{$customer->id}}" {{($posCollection->customerId == $customer->id) ? 'selected' : ''}}>{{ $customer->name }}</option>      
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="salesBillNo" name="salesBillNo">
                                            <option value="{{$posCollection->salesId}}">{{$posCollection->salesBillNo}}</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8" style="padding-right: 0px;">
                                        {!! Form::text('collectionDate', $posCollection->collectionDate, ['class' => 'form-control', 'id' => 'collectionDate', 'type' => 'text','placeholder' => 'Enter date','autocomplete'=>'off','style'=>'padding-right:0px']) !!}
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="project" name="projectId">
                                            ...
                                            @foreach($projects as $project)
                                                <option value="{{$project->id}}" {{($posCollection->projectId == $project->id) ? 'selected' : ''}}>{{ $project->name }}</option>      
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-9">
                                        <select name="paymentType" id="paymentTypeId" class="form-control">
                                            ...
                                            @foreach($payments as $payment)
                                                <option value="{{$payment->id}}" {{($posCollection->paymentType == $payment->id) ? 'selected' : ''}}>{{$payment->name}}</option>
                                        ...
                                        <select class="form-control" id="cashBankLedger" name="cashBankLedger">
                                            <option value="0">Select Ledger</option>
                                             @foreach($ledgerData as $ledger)
                                                <option value="{{$ledger->id}}" {{($posCollection->cashBankLedgerId == $ledger->id) ? 'selected' : ''}}>{{$ledger->name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        {!! Form::text('totalsalesAmount',$posCollection->salesId, ['class' => 'form-control', 'id' => 'totalSalesAmount', 'type' => 'text', 'readonly' => 'true','autocomplite'=>'off']) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        {!! Form::text('paidAmount',  $posCollection->collectionAmount, ['class' => 'form-control', 'id' => 'paidAmount', 'type' => 'text']) !!}
                                        <p id='paidAmountMsg' style="max-height:3px;"></p>
                                        <input type="hidden" name="id" value="{{$posCollection->id}}">
                                    </div>
                                </div>
