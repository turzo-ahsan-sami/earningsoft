                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="purchaseBillNo" name="purchaseBillNo">
                                            <option value="0">Select Purchase Bill No</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8" style="padding-right: 0px;">
                                        {!! Form::text('paymentDate', '', ['class' => 'form-control', 'id' => 'paymentDate', 'type' => 'text','placeholder' => 'Enter date','autocomplete'=>'off','style'=>'padding-right:0px']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        {!! Form::text('totalpurchaseAmount', 0, ['class' => 'form-control', 'id' => 'totalpurchaseAmount', 'type' => 'text', 'readonly' => 'true','autocomplite'=>'off']) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        {!! Form::text('paidAmount', '', ['class' => 'form-control', 'id' => 'paidAmount', 'type' => 'text']) !!}
