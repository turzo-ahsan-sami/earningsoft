		...
		<div class="row" style="margin-top: 30px;">
			...
			<div class="col-md-9">
				...
				<div style="margin-top: 50px;">
					<b>Subject:<u>Invoice Against Operation & Maintenance Bill for the Month of  {{$serviceDate}}</u></b>
				</div>
				  ...
				  <table class="table table-bordered" id="printTable" border="1pt solid ash" style="color:black; border-collapse: collapse; margin-top:10px;">
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align: left;">{{$productName}} Software Operation & Maintenance Bill for the Month of {{$serviceDate}} - Head Office</td>
							<?php } else if($receiveAllDataBySalesId->branchId==2){ ?>
							<td style="text-align: left;">{{$productName}} Software Operation & Maintenance Bill for the Month of {{$serviceDate}} - Branch</td>
							<?php } ?>
...
<script type="text/javascript">
	$("#printList").click(function(event) {
       var mainContents = document.getElementById("printServiceInvoice").innerHTML;
