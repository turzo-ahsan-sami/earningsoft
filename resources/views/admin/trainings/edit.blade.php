    ...
    <div class="card-body">
        <form action="{{ route("admin.trainings.update", [$training->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                <label for="description">{{ trans('cruds.training.fields.desc') }}</label>
                <input type="text" id="description" name="description" class="form-control" value="{{ old('description', isset($training) ? $training->description : '') }}">
