    ...
    <div class="card-body">
        <form action="{{ route("admin.banners.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('banner_text1') ? 'has-error' : '' }}">
                ...
                <input type="textarea" id="banner_text1" name="banner_text1" rows="5" cols="70" class="form-control" value="{{ old('banner_text1', isset($banner) ? $banner->banner_text1 : '') }}" required>
            ...
            <div class="form-group {{ $errors->has('banner_image') ? 'has-error' : '' }}">
                ...
                <input type="file" id="banner_image" name="banner_image" class="form-control" value="{{ old('logo', isset($banner) ? $banner->banner_image : '') }}" required>
            ...
            <div class="form-group {{ $errors->has('mini_image') ? 'has-error' : '' }}">
                ...
                <input type="file" id="mini_image" name="mini_image" class="form-control" value="{{ old('logo', isset($banner) ? $banner->mini_image : '') }}" required>
