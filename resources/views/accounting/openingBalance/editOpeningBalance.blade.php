                            ...
                            {{-- <div class="col-md-8"> --}}
                                    ...
                                    <div class="col-md-12"  style="padding: 0px 15px 0px 15px; ">
                                        <table id="editOpeningBalanceTable" class="table table-striped table-bordered">
                                            ...
                                            // dd($ledgers);
                                                ...
                                                @php
                                                $openingBalanceInfo = $openingBalanceInfos->where('ledgerId', $ledger->id)->first();

                                                if (!$openingBalanceInfo) {

                                                    $openingBalanceInfo =  (object) array(
                                                        'id' => 0,
                                                        'ledgerId'=> $ledger->id,
                                                        'debitAmount'=> 0,
                                                        'creditAmount'=> 0,
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="hidden openingBalanceIdColumn">
                                                        ...
                                                        <input type='hidden' name='openingBalanceId' class='openingBalanceIdInput' value=''>
                                                    </td>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 text-right">
                                        <input type="hidden" value="{{$openingBalanceInfo->id}}" name="id">
                                        @php
                                        $modify = 0;
                                        @endphp
                                        @if ($modify != 0)
