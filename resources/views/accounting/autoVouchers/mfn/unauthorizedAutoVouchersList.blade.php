        ...
        <div class="panel panel-default" style="background-color:#708090;">
            <div class="panel-heading"  style="padding-bottom:0px">
                <div class="panel-options">
                    ...
                    <a id="" href="javascript:;" class="btn btn-info pull-right addViewBtn unauthVoucher-modal " data-id="-1" >
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered dt-responsive nowrap"  id="voucherViewTable" style="color:black; font-size: 11px;">
                        ...
                        <tr>
                            ...
                            <th style="width:7%">Auto Voucher Date</th>
                        ...
                        @foreach($autoVouchers as $autoVoucher)
                            <tr class="item{{$autoVoucher->id}}">
                                ...
                                <td class="name" style="padding-left: 5px;">{{$autoVoucher->globalNarration}}</td>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="javascript:;" class="unauthVoucher-modal <?php if($userBranchId!=1){ echo 'disabled';}?> " data-id="{{$autoVoucher->id}}">
