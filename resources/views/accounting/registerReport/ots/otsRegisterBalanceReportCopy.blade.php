          ...
          <table id="registerReportTable" class="table table-striped table-bordered" style="color: black;font-size:11px;border-collapse: collapse;margin-bottom:50px;" border= "1px solid black;" cellpadding="0" cellspacing="0" width="100%">
            <thead >
              <tr>
                ...
                <th colspan="3">Interest Generated Amount (Tk)</th>            
                <th colspan="3">Interest Payment Amount (Tk)</th>            
                <th colspan="3">Closing Balance (Pri. + Int.)</th>            
              </tr>
              <tr>
                  <th>Up to Last Period</th>
            ...
            @endphp
             ...
             <td class="amount">{{number_format($interestPrevious,2,'.',',')}}</td>
             <td class="amount">{{number_format($interestCurrent,2,'.',',')}}</td>
             <td class="amount">{{number_format($interestTotal,2,'.',',')}}</td>

             <td class="amount">{{number_format($paymentPrevious,2,'.',',')}}</td>
             <td class="amount">{{number_format($paymentCurrent,2,'.',',')}}</td>
             <td class="amount">{{number_format($paymentTotal,2,'.',',')}}</td>

             <td class="amount">{{number_format($account->amount,2,'.',',')}}</td>
             <td class="amount">{{number_format($dueInterest,2,'.',',')}}</td>
             ...
             @php
                ...
                $gTsavings = $gTsavings + $account->amount;
                $gTdueInterest = $gTdueInterest + $dueInterest;
