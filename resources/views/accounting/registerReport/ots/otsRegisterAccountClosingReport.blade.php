    ...
    <div class="">
      <div class="panel panel-default" style="background-color:#708090;">
        <div class="panel-heading" style="padding-bottom:0px">
          ...
          <h3  style=" text-align: center; font-family: Antiqua; letter-spacing: 2px; color: white;">OTS Account Closing Report</h3>
        </div>
        {{-- <h5>kxghixd</h5> --}}
        ...
        <div class="panel-body panelBodyView">
           ...
           <div class="row" id="filtering-group">
                                ...
                                <div class="form-horizontal form-groups" style="padding-right: 0px;">
                                    ...
                                    {!! Form::open(['url' => 'viewOtsAccountClosingReport','method' => 'get']) !!}
            ...
            <div style="display: none;text-align: center;" id="hiddenTitle">
                           ...
                           <h4 style="text-align: center;padding: 0px;margin: 0px;">OTS Account Closing Report</h4>
          ...
          <table id="interestPaymentReportTable" class="table table-striped table-bordered" style="color: black;font-size:11px;border-collapse: collapse;margin-bottom:50px;" border= "1px solid black;" cellpadding="0" cellspacing="0" width="100%">
           <thead>
                    ...
                    @php
                        $total = 0;
                    @endphp
                     @foreach($closingAccounts as $index => $payment)
                     <tr>
                        <td>{{$index+1}}</td>
...
<style type="text/css">
#interestPaymentReportTable thead tr th{
        padding: 2px;
    }
