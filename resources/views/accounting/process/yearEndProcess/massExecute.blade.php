            ...
            <div class="">
                <div class="panel panel-default" style="background-color:#708090;">
                    <div class="panel-heading" style="padding-bottom:0px">
                        <h3  style="font-size: 2em; text-align: center; font-family: Antiqua; letter-spacing: 2px; color: white;">Execute Year End</h3>
                    </div>
...
$(document).ready(function() {
    ...
    $("#filterFormId").submit(function( event ) {
        ...
        $('#loadingModal').show();
        $("#reportingDiv").load('{{URL::to("./executeYearEnd")}}'+'?'+serializeValue, function(){
            $('#loadingModal').hide();
        });
    });
