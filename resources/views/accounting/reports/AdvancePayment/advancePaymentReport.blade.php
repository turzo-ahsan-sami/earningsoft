                       ...
                       <div class="row">
                         {{-- <div class="col-md-2"> --}}
                           {{-- <div class="row"> --}}
                             ...
                             <div class="col-md-2" id="projectDiv" style="padding-left:20px;">
                             ...
                             @endif   <!--end of Branch section-->
                             @if($userBranchId==1)   <!--start of Branch section-->
                             <div class="col-md-2" id="advanceTypeDiv" style="padding-left:20px;">
                               <div class="form-group" style="font-size: 13px; color:#212F3C">
      ...
      <script type="text/javascript">
        ...
        let a = $("<a />", {
          href: url,
          download: "Advance Payment Report_"+ today + ".xls"}).appendTo("body").get(0).click();
        e.preventDefault();
      });
        ...
        $("#printIcon").click(function(event) {
               ...
               // var printStyle = '<style>#reportingTable{float:left;height:auto;padding:0px;width:100% !important;font-size:11px;page-break-inside:auto; font-family: arial!important;}  thead tr th{text-align:center;vertical-align: middle;padding:3px;font-size:11px} tr{ page-break-inside:avoid; page-break-after:auto } table tbody tr td.amount{text-align:right !important;}</style><style media="print">@page{size: A4 portrait;margin:10mm 10mm;}</style><style>@media print {.element-that-contains-table { overflow: visible !important; }}</style><style>@page:first{tr:nth-of-type(4n){page-break-after: always;}}</style>';
                ...
                var printStyle =
                '<style>#reportingTable{float:left;height:auto;padding:0px;width:100%;font-size:11px;border:1pt solid ash;page-break-inside:auto;font-family: arial!important;} thead tr th{ text-align:center;vertical-align: middle;padding:3px;font-size:11px;} tbody tr td { text-align:right;vertical-align: middle;padding:3px ;font-size:10px;} tr{ page-break-inside:avoid; page-break-after:auto }tbody tr td:nth-child(2){text-align:left !important;} tbody tr td:nth-child(3){text-align:left !important;}tbody tr td:nth-child(1){text-align:center !important;}tbody tr.singleRow td:nth-child(1){text-align:left !important;}table tbody tr.subTotalData td:nth-child(1){ font-weight: bold !important;text-align:center !important;}table tbody tr.subTotalData td:nth-child(2){ font-weight: bold !important;text-align:center !important;}table tbody tr.subTotalData td:nth-child(2){ text-align:right!important;font-weight: bold;!important}table tbody tr.subTotalData td:nth-child(3),table tbody tr.subTotalData td:nth-child(4),table tbody tr.subTotalData td:nth-child(5){ text-align:right!important;font-weight: bold;!important} </style>   <style media="print">@page{size:portrait;margin:10mm 10mm;}</style><style>@media print {.element-that-contains-table { overflow: visible !important; }}</style><style>@page:first{tr:nth-of-type(4n){page-break-after: always;}}</style>';
        ...
        //
               ...
               var printContents = '<div id="order-details-wrapper"  style="padding: 10px;">' + headerContents + mainContentsUpper+printStyle+'<div>'+mainContents1+'</div>'+footerContents;
