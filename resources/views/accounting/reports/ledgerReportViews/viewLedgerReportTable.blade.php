...
<div id="printDiv">
    ...
    <div class="row" style="padding-bottom: 10px; text-align: center; vertical-align: middle; color: black; font-weight: bold; "> {{-- div for Company --}}
        ...
        <span style="font-size:14px;">{{ $ledgerReportLoadTableArr['company']->name }}</span><br/>
        <span style="font-size:11px;">{{ $ledgerReportLoadTableArr['company']->address }}</span><br/>
        <span style="text-decoration: underline;  font-size:14px;">Ledger Report</span></br>
        ...
        <div class="col-md-12"  style="font-size: 12px;">
            ...
            <span>
                <span style="color: black; float: left;">
                    ...
                    <span>{{$ledgerReportLoadTableArr['ledgerHead']}}</span>
                </span>
            ...
            <span>
                <span style="color: black; float: left;">
                    ...
                    <span>{{$ledgerReportLoadTableArr['projectName']}}</span>
                </span>
                <span style="color: black; float: right;">
                    <span style="font-weight: bold;">Reporting Date : <?php echo str_repeat('&nbsp;', 3);?></span>
                    <span>{{date('d-m-Y',strtotime($ledgerReportLoadTableArr['dateFrom']))." to ".date('d-m-Y',strtotime($ledgerReportLoadTableArr['dateTo']))}}</span>
                </span>
            </span>
            <br/>
            <span>
                <span style="color: black; float: left;">
                    ...
                    <span>{{$ledgerReportLoadTableArr['branchName']}}</span>
                </span>
                <span style="color: black; float: right;">
    ...
    <table id="ledgerReportTable" width="100%" class="table table-striped table-bordered" style="color:black; border-collapse: collapse;" border= "1px solid ash;">
        <thead>
            <tr>
