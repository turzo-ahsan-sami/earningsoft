...
@endphp
                    ...
                    <div class="panel panel-default" style="background-color:#708090;">
                        ...
                        <div class="panel-body panelBodyView" ><!--start of panel body-->
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        {!! Form::open(array('url' => './loadLedgerReport', 'role' => 'form', 'class'=>'form-horizontal form-groups', 'id' => 'filteringFormId', 'method'=>'get')) !!}
    ...
    $(document).ready(function() {
        ...
        $("#btnExportExcel").click(function(e) {
            ...
            let a = $("<a />", {
                href: url,
                download: "Ledger Report_"+ today + ".xls"}).appendTo("body").get(0).click();
                e.preventDefault();
            });
            ...
            $("#filteringFormId").submit(function( event ) {
                ...
                $('#loadingModal').show();
                $("#reportingDiv").load('{{URL::to("./loadLedgerReport")}}'+'?'+serializeValue, function(){
                    $('#loadingModal').hide();
                });
            });
            ...
            @endphp
            //console.log(userBranchStartDate);
            $("#dateFrom").datepicker({
                changeMonth: true,
                changeYear: true,
                yearRange : "{{ $minYear }}:c",
            ...
            $("#printIcon").click(function(event) {
                ...
                var footerContents = "<div class='row' style='font-size:12px; padding-left:5px; padding-top:20px;'>Prepared By<span style='display:inline-block; width: 33%; padding-top:40px;'></span> Checked By<span style='display:inline-block; width: 32%; padding-right:15px; padding-top:40px;'></span>Approved By</div>";
