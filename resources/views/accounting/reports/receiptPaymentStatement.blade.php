...
?>
    ...
    <tr class="item{{$child->id}}" level="{{$info['loopTrack']}}" @if($info['loopTrack']<=3){{"style=font-weight:bold;"}}@endif>
        <td style="text-align: left;">
         ...
         $childId = $child->id;
         $ledgerWiseData = $info['ledgerWiseData']->where('id', $childId);
        //
        //  $openingDebit = 0;
        //  $openingCredit = 0;
        //
         $currentDebit = $ledgerWiseData->sum('currentDebit');
         $currentCredit = $ledgerWiseData->sum('currentCredit');

         $dateRangeDebit = $ledgerWiseData->sum('dateRangeDebit');
         $dateRangeCredit = $ledgerWiseData->sum('dateRangeCredit');

         $thisMonthDebit = $ledgerWiseData->sum('thisMonthDebit');
         $thisMonthCredit = $ledgerWiseData->sum('thisMonthCredit');

         $previousFiscalYearDebit = $ledgerWiseData->sum('previousFiscalYearDebit');
         $previousFiscalYearCredit = $ledgerWiseData->sum('previousFiscalYearCredit');
        //
        //  $debitSum = 0;
        //  $creditSum = 0;
        //
        ...
        //  $currentDebitForCumulative = 0;
         $cumulativeDebit = $ledgerWiseData->sum('cumulativeDebit');
         $cumulativeCredit = $ledgerWiseData->sum('cumulativeCredit');
        //
        ...
        <td></td>
        <td class="currentPeriod" amount="@if($info['type']=='receipt'){{$dateRangeDebit}}@else {{$dateRangeCredit}} @endif" style="text-align: right; padding: 0 5px 0 10px;">@if($info['type']=='receipt'){{number_format($dateRangeDebit,2)}}@else {{number_format($dateRangeCredit,2)}} @endif</td>
        @endif
...
// dd($previousPreviousfiscalYearId);
            ...
            if ($data['searchMethodSelected']==1) {
                ...
                if ($data['roundUpSelected']==1) {
                    ...
                    <td style='text-align: left;'>CLOSING BALANCE</td>
                    <td></td>
                    <td id='cbPreviousFiscalYear' amount='".($data['cbPreviousYear'])."' style='text-align: right;padding-right:5px;font-weight:bold;'>".number_format($data['cbPreviousYear'],2)."</td>

                    <td id='cbCurrentFiscalYear' amount='".($data['cbThisYear'])."' style='text-align: right;padding-right:5px;font-weight:bold;'>".number_format($data['cbThisYear'],2)."</td>
                    </tr>".
                    "<tr>
                    <td style='text-align: left;'>CASH IN HAND</td>
                    <td></td>
                    <td id='cashInHandForPreviousFiscalYear' amount='' style='text-align: right;padding-right:5px;'>".number_format($data['cbPreviousYearCash'], 2)."</td>
                    <td style='text-align: right;padding-right:5px;'>".number_format($data['cbThisYearCash'],2)."</td>
                    </tr>".
                    "<tr>
                    <td style='text-align: left;'>CASH AT BANK</td>
                    <td></td>
                    <td id='cashInBankForPreviousFiscalYear' amount='' style='text-align: right;padding-right:5px;'>".number_format($data['cbPreviousYearBank'], 2)."</td>
                    <td style='text-align: right;padding-right:5px;'>".number_format($data['cbThisYearBank'], 2)."</td>
                    </tr>"
                    ;
                }
                else{
                    ...
                    <td style='text-align: left;'>CASH IN HAND</td>
                    <td></td>
                    <td style='text-align: right;padding-right:5px;'>".number_format($data['cbPreviousYearCash'],2,'.','')."</td>
                    <td style='text-align: right;padding-right:5px;'>".number_format($data['cbThisYearCash'],2,'.','')."</td>
                    </tr>".
                    "<tr>
                    <td style='text-align: left;'>CASH AT BANK</td>
                    <td></td>
                    <td style='text-align: right;padding-right:5px;'>".number_format($data['cbPreviousYearBank'],2,'.','')."</td>
                    <td style='text-align: right;padding-right:5px;'>".number_format($data['cbThisYearBank'],2,'.','')."</td>
                    </tr>"
                    ;
                }
            ...
            elseif ($data['searchMethodSelected']==2) {
                ...
                if ($data['roundUpSelected']==1) {
                    ...
                    <td style='text-align: left;'>CLOSING BALANCE</td>
                    <td></td>
                    <td  id='cbThisMonth' amount='".($data['cbThisMonth'])."' style='text-align: right;padding-right:5px;font-weight:bold;font-weight:bold;'>".number_format($data['cbThisMonth'],2)."</td>
                    <td id='cbThisYear' amount='".($data['cbThisYear'])."' style='text-align: right;padding-right:5px;font-weight:bold;font-weight:bold;'>".number_format($data['cbThisYear'],2)."</td>
                    <td id='cbCumulative' amount='".($data['cbThisYear'])."' style='text-align: right;padding-right:5px;font-weight:bold;'>".number_format($data['cbThisYear'],2)."</td>
                    </tr>".
                    "<tr>
                    <td style='text-align: left;'>CASH IN HAND</td>
                    <td></td>
                    <td style='text-align: right;padding-right:5px;'>".number_format($data['cbThisMonthCash'], 2)."</td>
                    <td style='text-align: right;padding-right:5px;'>".number_format($data['cbThisYearCash'],2)."</td>
                    <td style='text-align: right;padding-right:5px;'>".number_format($data['cbThisYearCash'],2)."</td>
                    ...
                    <td style='text-align: left;'>CASH AT BANK</td>
                    <td></td>
                    <td style='text-align: right;padding-right:5px;'>".number_format($data['cbThisMonthBank'],2)."</td>
                    <td style='text-align: right;padding-right:5px;'>".number_format($data['cbThisYearBank'],2)."</td>
                    <td style='text-align: right;padding-right:5px;'>".number_format($data['cbThisYearBank'],2)."</td>
            ...
            elseif ($data['searchMethodSelected']==3) {
                ...
                if ($data['roundUpSelected']==1) {
                    ...
                    <td style='text-align: left;'>CLOSING BALANCE</td>
                    <td></td>
                    <td id='cbThisPeriod' amount='".($data['cbThisPeriod'])."' style='text-align: right;padding-right:5px;font-weight:bold;'>".number_format($data['cbThisPeriod'],2)."</td>
                    </tr>".
                    "<tr>
                    <td style='text-align: left;'>CASH IN HAND</td>
                    <td></td>
                    <td style='text-align: right;padding-right:5px;'>".number_format($data['cbThisPeriodCash'],2)."</td>
                    </tr>".
                    "<tr>
                    <td style='text-align: left;'>CASH AT BANK</td>
                    <td></td>
                    <td style='text-align: right;padding-right:5px;'>".number_format($data['cbThisPeriodBank'],2)."</td>
                    </tr>"
                    ;
                }
                else{
...
@php
    // dd($searchMethodSelected);
@endphp
    if ($("#dateFrom").val()=="") {
        //changes done here ********************************
        @if ($searchMethodSelected ==3)
