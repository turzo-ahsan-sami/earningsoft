                ...
                <div class="">
                    ...
                    <div class="panel-body panelBodyView" ><!--start of panel body-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    {!! Form::open(array('url' => './loadCashBookReport', 'role' => 'form', 'class'=>'form-horizontal form-groups', 'id' => 'filteringFormId', 'method'=>'get')) !!}
                                    {{-- @if($userBranchCode == 0) --}}
...
<!-- 
                                     <div class="col-md-2 hidden">
                                        <div class="form-group" style="font-size: 13px; color:#212F3C;">
                                            {!! Form::label('', 'Ledger:', ['class' => 'control-label col-sm-12']) !!}
                                            <div class="col-sm-12">
                                                <select class="form-control selectPicker" name="ledgerId" id="ledgerId"  required="required">
                                                    {{-- <option value="">Select Ledger</option> --}}
                                                    @foreach ($ledgers as $ledger)
                                                    <option value={{$ledger->id}}>{{$ledger->code." - ".$ledger->name}}</option>
                                                    @endforeach
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
       ...
       $("#btnExportExcel").click(function(e) {
        ...
        let a = $("<a />", {
          href: url,
          download: "Cash Book Report_"+ today + ".xls"}).appendTo("body").get(0).click();
        e.preventDefault();
    });
...
function changeReportLevel(elm){
    ...
    $("#filteringFormId").submit(function( event ) {
        ...
        $('#loadingModal').show();
        $("#reportingDiv").load('{{URL::to("./loadCashBookReport")}}'+'?'+serializeValue, function(){
            $('#loadingModal').hide();
        });
    });
