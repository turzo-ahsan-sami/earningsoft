...
<div id="printDiv">
    ...
    <div class="row" style="padding-bottom: 10px; text-align: center; vertical-align: middle; color: black; font-weight: bold; "> {{-- div for Company --}}
        ...
        <span style="font-size:14px;">{{ $cashBookReportLoadTableArr['company']->name }}</span><br/>
        <span style="font-size:11px;">{{ $cashBookReportLoadTableArr['company']->address }}</span><br/>
        <span style="text-decoration: underline;  font-size:14px;">Cash Book Report</span></br>
        ...
        <div class="col-md-12"  style="font-size: 12px;">
            ...
            <span>
                <span style="color: black; float: left;">
                    ...
                    <span>{{$cashBookReportLoadTableArr['ledgerHead']}}</span>
                </span>
            ...
            <span>
                <span style="color: black; float: left;">
                    ...
                    <span>{{$cashBookReportLoadTableArr['projectName']}}</span>
                </span>
                <span style="color: black; float: right;">
                    <span style="font-weight: bold;">Reporting Date : <?php echo str_repeat('&nbsp;', 3);?></span>
                    <span>{{date('d-m-Y',strtotime($cashBookReportLoadTableArr['dateFrom']))." to ".date('d-m-Y',strtotime($cashBookReportLoadTableArr['dateTo']))}}</span>
                </span>
            </span>
            <br/>
            <span>
               <!-- <span style="color: black; float: left;">
                    ...
                    <span>{{$cashBookReportLoadTableArr['projectType']}}</span>
                </span>-->
                 <span style="color: black; float: left;">
                    <span style="font-weight: bold;">Branch: <?php echo str_repeat('&nbsp;', 3);?></span>
                    <span>{{$cashBookReportLoadTableArr['branchName']}}</span>
                </span>
                <span style="color: black; float: right;">
    ...
    <table id="cashBookReportTable" class="table table-striped table-bordered" style="color:black; border-collapse: collapse;" border= "1px solid ash;">
        <thead>
            <tr>
