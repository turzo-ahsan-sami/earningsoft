        ...
        $amount = 0;
            ...
            if ($child->isGroupHead==0) {
                ...
                //Previous Year Debit Credit
                 ...
                 $previousFiscalYearDebit = DB::table('acc_opening_balance')
                                            ->where('ledgerId',$childId)
                                            ->where('fiscalYearId',$previousfiscalYearId)
                                            ->where('projectId',$info['projectSelected'])
                                            ->whereIn('projectTypeId',$info['projectTypeId'])
                                            ->whereIn('branchId',$info['newBranches'])
                                            ->sum('debitAmount');
               ...
               /* $previousFiscalYearCredit = DB::table('acc_voucher_details')                                       
                ...
                $previousFiscalYearCredit = DB::table('acc_opening_balance')
                                            ->where('ledgerId',$childId)
                                            ->where('fiscalYearId',$previousfiscalYearId)
                                            ->where('projectId',$info['projectSelected'])
                                            ->whereIn('projectTypeId',$info['projectTypeId'])
            ...
            $thisMonthCredit = $thisChildVoucherDetails
                ...
                if ($previousfiscalYearId!=null) {
                    $openingDebitForCumulative = DB::table('acc_opening_balance')
                                                    ->where('ledgerId',$childId)
                                                    ->where('projectId',$info['projectSelected'])
                                                    ->whereIn('projectTypeId',$info['projectTypeId'])
                                                    ->whereIn('branchId',$info['newBranches'])
                    ...
                    $openingCreditForCumulative = DB::table('acc_opening_balance')
                                                    ->where('ledgerId',$childId)
                                                    ->where('projectId',$info['projectSelected'])
                                                    ->whereIn('projectTypeId',$info['projectTypeId'])
                                                    ->whereIn('branchId',$info['newBranches'])
 ...
 function printOpeningBalance($data)
    {
        ...
        if ($data['searchMethodSelected']==1) {
            ...
            "<tr>
                ...
                <td id='cashInHandForCurrentFiscalYear' amount='".$cashInHandForCurrentFiscalYear."' style='text-align: right;padding-right:5px;'>".number_format($cashInHandForCurrentFiscalYear,2)."</td>
            </tr>".
            "<tr>
                <td style='text-align: left;'>CASH AT BANK</td>
                <td></td>
                <td style='text-align: right;padding-right:5px;'>".number_format($cashInBankForPreviousFiscalYear,2)."</td>
                <td id='cashInBankForCurrentFiscalYear' amount='".$cashInBankForCurrentFiscalYear."' style='text-align: right;padding-right:5px;'>".number_format($cashInBankForCurrentFiscalYear,2)."</td>
            </tr>"
            ;
            }
            else{
        ...
        elseif ($data['searchMethodSelected']==2) {
            ...
            $obThisMonth = $cashInHandForCurrentFiscalYear+$data['thisMonthTransactionOfCashTypeDebit']-$data['thisMonthTransactionOfCashTypeCredit']+$cashInBankForCurrentFiscalYear+$data['thisMonthTransactionOfBankTypeDebit']-$data['thisMonthTransactionOfBankTypeCredit'];
            ...
            "<tr>
                <td style='text-align: left;'>CASH IN HAND</td>
                <td></td>
                <td style='text-align: right;padding-right:5px;'>".number_format($cashInHandForCurrentFiscalYear+$data['thisMonthTransactionOfCashTypeDebit']-$data['thisMonthTransactionOfCashTypeCredit'],2)."</td>
                <td style='text-align: right;padding-right:5px;'>".number_format($cashInHandForCurrentFiscalYear,2)."</td>
                <td></td>
            </tr>".
            "<tr>
    ...
    function printClosingBalance($data)
    {
        ...
        if ($data['searchMethodSelected']==1) {
          ...
          if ($data['roundUpSelected']==1) {
            ...
            "<tr>
                <td style='text-align: left;'>CASH IN HAND</td>
                <td></td>
                <td id='cashInHandForPreviousFiscalYear' amount='' style='text-align: right;padding-right:5px;'>".number_format($cashInHandForPreviousFiscalYear+$previousFiscalYearCash,2)."</td>
                <td style='text-align: right;padding-right:5px;'>".number_format($cashInHandForCurrentFiscalYear+$currentFiscalYearCash,2)."</td>
            </tr>".
            "<tr>
                <td style='text-align: left;'>CASH AT BANK</td>
                <td></td>
                <td id='cashInBankForPreviousFiscalYear' amount='' style='text-align: right;padding-right:5px;'>".number_format($cashInBankForPreviousFiscalYear+$previousFiscalYearBank,2)."</td>
        ...
        elseif ($data['searchMethodSelected']==2) {
            ...
            $obThisMonth = $cashInHandForCurrentFiscalYear+$data['thisMonthTransactionOfBankTypeDebit']-$data['thisMonthTransactionOfBankTypeCredit']+$cashInBankForCurrentFiscalYear+$data['thisMonthTransactionOfCashTypeDebit']-$data['thisMonthTransactionOfCashTypeCredit'];
            $obThisYear = $cashInHandForCurrentFiscalYear+$cashInBankForCurrentFiscalYear;
          ...
          if ($data['roundUpSelected']==1) {
            ...
            "<tr>
                <td style='text-align: left;'>CASH IN HAND</td>
                <td></td>
                <td style='text-align: right;padding-right:5px;'>".number_format($cashInHandForCurrentFiscalYear+$data['thisMonthTransactionOfCashTypeDebit']-$data['thisMonthTransactionOfCashTypeCredit']+$thisMonthCash,2)."</td>
                <td style='text-align: right;padding-right:5px;'>".number_format($cashInHandForCurrentFiscalYear+$currentFiscalYearCash,2)."</td>
                <td style='text-align: right;padding-right:5px;'>".number_format($cashInHandForCurrentFiscalYear+$currentFiscalYearCash,2)."</td>
