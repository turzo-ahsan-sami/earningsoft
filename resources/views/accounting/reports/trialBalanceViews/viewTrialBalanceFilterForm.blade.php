            ...
            <div class="">
                <div class="panel panel-default" style="background-color:#708090;">
                    <div class="panel-heading" style="padding-bottom:0px">
                        ...
                        <h3  style=" text-align: center; font-family: Antiqua; letter-spacing: 2px; color: white;">Trial Balance Report</h3>
                    </div>
                    ...
                    <div class="panel-body panelBodyView" ><!--start of panel body-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    {!! Form::open(array('url' => './trialBalanceLoadReport', 'role' => 'form', 'class'=>'form-horizontal form-groups', 'id' => 'filteringFormId', 'method'=>'get')) !!}
                                    ...
                                    <div class="col-md-1" style="display: none;" id="dateFromDiv">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                {!! Form::text('dateFrom', $branchDate, ['id'=>'dateFrom','placeholder'=>'From','class'=>'form-control','readonly','style'=>'cursor:pointer', 'autocomplete'=>'off']) !!}
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
       ...
       $("#btnExportExcel").click(function(e) {
        ...
        let a = $("<a />", {
          href: url,
          download: "Trial Balance Report_"+ today + ".xls"}).appendTo("body").get(0).click();
        e.preventDefault();
    });
    ...
    $("#filteringFormId").submit(function( event ) {
        ...
        $('#loadingModal').show();
        $("#reportingDiv").load('{{URL::to("./trialBalanceLoadReport")}}'+'?'+serializeValue, function(){
            $('#loadingModal').hide();
        });
    });
