        ...
        <div class="panel panel-default" style="background-color:#708090;">
            ...
            <div class="panel-body panelBodyView">
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="col-md-2"> --}}
                                {{-- <div class="row"> --}}
                                    ...
                                    {!! Form::open(array('url' => 'bankBookReport/', 'role' => 'form', 'class'=>'form-horizontal form-groups', 'id' => 'bankReportForm', 'method'=>'get')) !!}
                ...
                <?php
                    ...
                    $openingBalanceAmountByDate = DB::table('acc_opening_balance')->whereIn('projectId',$projectIdArray)->whereIn('projectTypeId',$projectTypeIdArray)->whereIn('branchId',$branchIdArray)->whereIn('ledgerId', $ledgerIdsArray)->where('fiscalYearId', $previousFiscalYearValue->id)->sum('balanceAmount');
...
//
                ...
                <div id="printDiv">
                    ...
                    <div class="row" style=" margin: 15px 0px;">
                        ...
                        <table class="table table-striped table-bordered" id="accBankBookReportTable" border="1pt solid ash" style="border-collapse: collapse;" >
