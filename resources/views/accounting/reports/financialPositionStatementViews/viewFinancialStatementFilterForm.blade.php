                ...
                <div class="panel panel-default" style="background-color:#708090;">
                    ...
                    <div class="panel-body panelBodyView" ><!--start of panel body-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    {!! Form::open(array('url' => './financialStatementLoadReport', 'role' => 'form', 'class'=>'form-horizontal form-groups', 'id' => 'filteringFormId', 'method'=>'get')) !!}
                                    ...
                                    <div class="col-md-1" id="areaDiv" style="display: none;" hidden>
                                        <div class="form-group" style="font-size: 13px; color:#212F3C">
                                            <div class="col-md-12">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $("#btnExportExcel").click(function(e) {
        ...
        let a = $("<a />", {
          href: url,
          download: "Statement of Financial Position_"+ today + ".xls"}).appendTo("body").get(0).click();
        e.preventDefault();
    });
    ...
    $('#filProjectType').append(function(e){
        ...
        if (projectId == 0) {
            ...
            $.ajax({
                type: 'post',
                url: "./financialStatementProjectType",
    ...
    $("#filteringFormId").submit(function( event ) {
        ...
        $('#loadingModal').show();
        $("#reportingDiv").load('{{URL::to("./viewFinancialStatementTable")}}'+'?'+serializeValue, function(){
            $('#loadingModal').hide();
        });
    });
