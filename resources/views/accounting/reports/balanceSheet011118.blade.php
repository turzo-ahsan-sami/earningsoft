...
<div class="" style="">
    ...
    //===============================================Starts Calculate Surplus===============================================
                    ...
                    if($searchedSearchMethod==2){
                        ...
                        $incomeDebitAmountByCurrFIEndDay = $vouchersInfo
                                                            // ->where('status',1)
                                                            // ->whereIn('voucherId',$voucherIdMatchedByFIEndDay)
                                                            ->whereIn('debitAcc', $incomeLedgerIds)
                                                            ->sum('amount');
                        $incomeCreditAmountByCurrFIEndDay = $vouchersInfo
                                                            // ->where('status',1)
                                                            // ->whereIn('voucherId',$voucherIdMatchedByFIEndDay)
                        ...
                        $expenseDebitAmountByCurrFIEndDay = $vouchersInfo
                                                            // ->where('status',1)
                                                            // ->whereIn('voucherId',$voucherIdMatchedByFIEndDay)
                                                            ->whereIn('debitAcc', $expenseLedgerIds)
                                                            ->sum('amount');
                        $expenseCreditAmountByCurrFIEndDay = $vouchersInfo
                                                            // ->where('status',1)
                                                            // ->whereIn('voucherId',$voucherIdMatchedByFIEndDay)
