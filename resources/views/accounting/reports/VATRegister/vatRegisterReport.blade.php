    ...
    <div class="" style="">
      <div class="">
          ...
          <div class="panel-heading" style="padding-bottom:0px">
            <div class="panel-options">
                   {{--  <button id="printIcon" class="btn btn-info pull-right print-icon" style="">
                    ...
                    <h3  style=" text-align: center; font-family: Antiqua; letter-spacing: 2px; color: white;">VAT Register Report</h3>
                  </div>
                            ...
                            {{-- <div class="row"> --}}
                              ...
                              <div class="col-md-1" id="branchDiv" >
                                <div class="form-group" style="font-size: 13px; color:#212F3C">
                                  {!! Form::label('', 'Supplier:', ['class' => 'control-label col-sm-12']) !!}
                                  <div class="col-sm-12">
                              ...
                              <div class="col-md-1" id="projectDiv" style="padding-left:20px;">
                                <div class="form-group" style="font-size: 13px; color:#212F3C">
                                  {!! Form::label('', 'Project List:', ['class' => 'control-label col-sm-12']) !!}
                                  <div class="col-sm-12">
                              ...
                              @if($userBranchId==1)   <!--start of Branch section-->
                              <div class="col-md-1" id="projectTypeDiv" style="padding-left:30px;">
                                <div class="form-group" style="font-size: 13px; color:#212F3C">
                                  {!! Form::label('', 'Project Type List:', ['class' => 'control-label col-sm-12']) !!}
                                  <div class="col-sm-12">
       ...
       <script type="text/javascript">
        ...
        let a = $("<a />", {
          href: url,
          download: "VAT Register Report_"+ today + ".xls"}).appendTo("body").get(0).click();
        e.preventDefault();
      });
          ...
          $("#filProject").change(function(event){
            ...
            $.ajax({
              type: 'post',
              url: "./vatRegisterReportProjectTypeAjax",
              data: {projectAjax: projectAjax},
              success: function(data) {
               console.log(data);
               $("#filProjectType").empty();
               $("#filProjectType").append("<option value='null'>--Select Project Type--</option>");
...
$("#filteringFormId").submit(function( event ) {
 ...
 $("#reportingDiv").load('{{URL::to("./vatRegisterReportLowerPart")}}'+'?'+serializeValue);
