...
@section('title', '| Statement of Comprehensive Income')
@section('content')

<style type="text/css">
#comprehensiveIncomeReportTable{
                ...
                <div class="panel panel-default" style="background-color:#708090;">
                    ...
                    <div class="panel-body panelBodyView" ><!--start of panel body-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    {!! Form::open(array('url' => './comprehensiveIncomeLoadReport', 'role' => 'form', 'class'=>'form-horizontal form-groups', 'id' => 'filteringFormId', 'method'=>'get')) !!}
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
       ...
       $("#btnExportExcel").click(function(e) {
        ...
        let a = $("<a />", {
          href: url,
          download: "Statement of Comprehensive Income Report_"+ today + ".xls"}).appendTo("body").get(0).click();
        e.preventDefault();
    });
    ...
    $('#filProjectType').append(function(e){
        ...
        if (projectId == 0) {
            ...
            $.ajax({
                type: 'post',
                url: "./comprehensiveIncomeProjectType",
    ...
    //                 $("#filBranch").append('<option value="All">All (With HO)</option>');
    //                 $("#filBranch").append('<option value="0">All (WithOut HO)</option>');
    //                 $("#filBranch").append('<option value="'+headOfficeId+'">000 - Head Office</option>');
...
function changeReportLevel(elm){
    ...
    $("#filteringFormId").submit(function( event ) {
        ...
        $('#loadingModal').show();
        $("#reportingDiv").load('{{URL::to("./comprehensiveIncomeLoadReport")}}'+'?'+serializeValue, function(){
            $('#loadingModal').hide();
        });
    });
