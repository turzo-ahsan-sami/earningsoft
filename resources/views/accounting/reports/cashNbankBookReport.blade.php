                    ...
                    <div class="panel panel-default" style="background-color:#708090;">
                        ...
                        <div class="panel-body panelBodyView">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1" id="branchDiv" @if ($userBranchCode != 0) style="display: none;"@endif> 
                                            <div class="form-group" style="font-size: 13px; color:#212F3C">
                                                <div class="col-md-12">
                                                    {!! Form::label('', 'Branch:', ['class' => 'control-label pull-left']) !!}
                                                </div>
                                                <div class="col-md-12">
                                                    {!! Form::select('branchId', $branchLists, null ,['id'=>'branchId','class'=>'form-control input-sm','autocomplete'=>'off']) !!}
                                        ...
                                        <div class="col-md-1" id="projectTypeDiv" hidden>
                                            <div class="form-group" style="font-size: 13px; color:#212F3C">
                                                ...
                                                <div class="col-md-12">
                                                    {!! Form::select('filProjectType', $projectTypes, null ,['id'=>'filProjectType','class'=>'form-control input-sm','autocomplete'=>'off']) !!}
                                                ...
                                                <?php 
                                                    $dateFromSelected= date("d-m-Y",strtotime($startDate));
                                                    //dd($dateFromSelected);
                                                ?>
                                                <div class="col-md-1">
                                                    <div class="form-group" style="font-size: 13px; color:#212F3C">
                                                ...
                                                <?php 
                                                    $dateToSelected= date("d-m-Y",strtotime($userBranchDate));
                                                    //dd($dateToSelected);
                                                ?>
                                                <div class="col-md-1">
                                                    <div class="form-group" style="font-size: 13px; color:#212F3C">
                                                        ...
                                                        <div class="col-md-12">
                                                            {!! Form::text('dateTo', $dateToSelected, ['id'=>'dateTo','placeholder'=>'To','class'=>'form-control dateTo','readonly','style'=>'cursor:pointer', 'autocomplete'=>'off']) !!}
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            if(isset($_GET['projectId']) || isset($_GET['ledgerId'])){
                                ...
                                //dd($projectIdArray,$projectTypeIdArray,$branchIdArray,$voucherTypeIdArray,$startDate,$endDate);
                            ...
                            //dd($fiscalYearValue);
                                ...
                                $fiscalYearValue = DB::table('gnr_fiscal_year')->where('companyId',Auth::user()->company_id_fk)->where('fyStartDate','<=',$startDate)->where('fyEndDate','>=',$startDate)->select('fyStartDate', 'fyEndDate', 'id')->first();
                                //dd($fiscalYearValue);
                               ...
                               // $previousFisEndDate=date('Y-m-d', strtotime("last day of -1 year".$fiscalYearValue->fyEndDate));
                                //dd($previousFisStartDate,$previousFisEndDate);
                                 $previousFisStartDate=date('Y-m-d', strtotime($fiscalYearValue->fyStartDate));
                                $previousFisEndDate=date('Y-m-d', strtotime($fiscalYearValue->fyEndDate));
                                // dd($previousFisStartDate,$previousFisEndDate);
                                //dd($previousFisStartDate);
                                $previousFiscalYearValue = DB::table('gnr_fiscal_year')->where('companyId',Auth::user()->company_id_fk)->where('fyStartDate',$previousFisStartDate)->where('fyEndDate',$previousFisEndDate)->select('fyStartDate', 'fyEndDate', 'id')->first();
                                ...
                                //dd($previousFiscalYearValue);
                                 $openingBalanceAmountByDate = DB::table($acc_opening_balance)->where('companyIdFk', $user_company_id)->whereIn('projectId',$projectIdArray)->whereIn('projectTypeId',$projectTypeIdArray)->whereIn('branchId',$branchIdArray)->whereIn('ledgerId', $ledgerIdsArray)->where('fiscalYearId', $previousFiscalYearValue->id)->sum('balanceAmount');
                                    ...
                                    <div class="col-md-12"  style="font-size: 12px;" >
                                        <?php
                                            ...
                                            if($searchedProjectId == ""){
                                                ...
                                                //$project = DB::table('gnr_project')->where('id',$searchedProjectId)->where('companyId',Auth::user()->company_id_fk)->select('name')->first();
                                                $project = DB::table('gnr_project')->where('id',$searchedProjectId)->where('companyId',Auth::user()->company_id_fk)->value('name');
                                            }
                    ...
                    if (projectId == 0) {
                        ...
                        $.ajax({
                            ...
                            success: function (data){
                                ...
                                $("#branchId").empty();
                                $("#branchId").append('<option value="All">All</option>');
            ...
            $(document).ready(function(){
                ...
                $(function(){
                    $("#printIcon").click(function(){
                        // $("#accBankBookReportTable").removeClass('tablezzz table-striped table-bordered');
