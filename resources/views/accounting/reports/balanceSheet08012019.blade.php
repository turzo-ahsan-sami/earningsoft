...
<?php
    ...
    function eachRow($child, $loopTrack, $voucherIdMatched, $searchedRoundUp, $searchedSearchMethod, $voucherIdMatchedByFIEndDay, $type, $totalBalanceOfPreviousFisYear, $searchedFiscalYearId, $searchedBranchId, $startDate, $endDate, $previousFisIdOfCurrentFisYear, $projectIdArray, $projectTypeIdArray, $branchIdArray) { ?>
    ...
    <tr class="item{{$child->id}}" level={{$loopTrack}} type={{$type}}>
        ...
        {{-- Fiscal Year --}}
        @php
        $previousFisYearOpeningBalanceInfos = DB::table('acc_opening_balance')
                                            ->where('ledgerId', $child->id)
                                            ->whereIn('projectId',$projectIdArray)
                                            ->whereIn('projectTypeId',$projectTypeIdArray)
                                            ->whereIn('branchId',$branchIdArray)
...
<div class="" style="">
    ...
    //===============================================Starts Calculate Surplus===============================================
                    ...
                    $incomeBalanceOfPreviousFisYear=$expenceBalanceOfPreviousFisYear=$incomeBalance=$incomeDebitAmount=$incomeCreditAmount=$expenseBalance=$expenseDebitAmount=$expenseCreditAmount=$totalSurplusOFCurrentFI=0;
                            ...
                            <table class="table table-striped table-bordered" id="accBalanceSheetTable" border="1pt solid ash" style="border-collapse: collapse;" >
                                ...
                                @if(in_array($ledger->id,$ledgerMatchedId))
                                    ...
                                    @if(in_array($child1->id,$ledgerMatchedId))
                                        <?php
                                        $loopTrack=1;
                                        eachRow($child1, $loopTrack, $voucherIdMatched, $searchedRoundUp, $searchedSearchMethod, $voucherIdMatchedByFIEndDay, $type, $totalBalanceOfPreviousFisYear, $searchedFiscalYearId, $searchedBranchId, $startDate, $endDate, $previousFisIdOfCurrentFisYear, $projectIdArray, $projectTypeIdArray, $branchIdArray);
                                        ...
                                        @if(in_array($child2->id,$ledgerMatchedId))
                                            <?php
                                            $loopTrack=2;
                                            eachRow($child2, $loopTrack, $voucherIdMatched, $searchedRoundUp, $searchedSearchMethod, $voucherIdMatchedByFIEndDay, $type, $totalBalanceOfPreviousFisYear, $searchedFiscalYearId, $searchedBranchId, $startDate, $endDate, $previousFisIdOfCurrentFisYear, $projectIdArray, $projectTypeIdArray, $branchIdArray);
                                            ...
                                            @if(in_array($child3->id,$ledgerMatchedId))
                                                <?php
                                                $loopTrack=3;
                                                eachRow($child3, $loopTrack, $voucherIdMatched, $searchedRoundUp, $searchedSearchMethod, $voucherIdMatchedByFIEndDay, $type, $totalBalanceOfPreviousFisYear, $searchedFiscalYearId, $searchedBranchId, $startDate, $endDate, $previousFisIdOfCurrentFisYear, $projectIdArray, $projectTypeIdArray, $branchIdArray);
                                                ...
                                                @if(in_array($child4->id,$ledgerMatchedId))
                                                    <?php
                                                    $loopTrack=4;
                                                    eachRow($child4, $loopTrack, $voucherIdMatched, $searchedRoundUp, $searchedSearchMethod, $voucherIdMatchedByFIEndDay, $type, $totalBalanceOfPreviousFisYear, $searchedFiscalYearId, $searchedBranchId, $startDate, $endDate, $previousFisIdOfCurrentFisYear, $projectIdArray, $projectTypeIdArray, $branchIdArray);
                                                    ...
                                                    @if(in_array($child5->id,$ledgerMatchedId))
                                                        <?php
                                                        $loopTrack=5;
                                                        eachRow($child5, $loopTrack, $voucherIdMatched, $searchedRoundUp, $searchedSearchMethod, $voucherIdMatchedByFIEndDay, $type, $totalBalanceOfPreviousFisYear, $searchedFiscalYearId, $searchedBranchId, $startDate, $endDate, $previousFisIdOfCurrentFisYear, $projectIdArray, $projectTypeIdArray, $branchIdArray);
                                                        ?>
                                                    @endif
