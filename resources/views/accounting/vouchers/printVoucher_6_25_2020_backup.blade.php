...
//dd($userEmployeeId,$approveEmployee->id);
if($settingsExist == 1) {
    ...
    }elseif ($verifyEmployee != null && $reviewEmployee != null) {
        $verifyEmployeeId = $verifyEmployee->id;
        $reviewEmployeeId = $reviewEmployee->id;
        $approveEmployeeId =0;
    }elseif ($verifyEmployee != null && $reviewEmployee != null && $approveEmployee !=null) {
...
//dd($verifyEmployeeId,$reviewEmployeeId);
//dd(Auth::user());
//dd($userEmployeeId);
//dd($userEmployeeId);
...
<div class="row add-data-form">
            ...
            <div class="panel panel-default panel-border">
                <div class="panel-body">
                    <div class="row">
                            ...
                            <div id="printView">
                                ...
                                <div class="row" style="padding: 0px 15px;">       {{-- div for Voucher --}}
                                    ...
                                    <table id="voucherInfoTable">
                                        ...
                                        {{-- <tbody>
                                            <tr>
                                                <td style="font-weight: bold; width: 10px;"> Project Name</td>
                                                <td style="width: 10px;">:</td>
                                                <td style="width: 150px;">{{$projectName}}</td>
                                                <td></td>
                                                <td style="font-weight: bold; width: 90px;"> Voucher Code</td>
                                                <td style="width: 10px;">:</td>
                                                <td style="width: 120px;">{{$voucherIdInfo->voucherCode}}</td>
                                            </tr>
                                            <tr>
                                                <td style="font-weight: bold;"> Project Type</td>
                                                <td>:</td>
                                                    ...
                                                    <div class="row" class="secondStepVerify" style="padding: 20px 14px 5px 14px; " id="removeSecondStepDiv">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group positionClass">
                                                                    <p>Comment Box</p>
                                                                    <textarea class="col-sm-12 form-groups commentStyle" name="commentsDetails" id ="reviewCommentsDetails" class="reviewCommentsDetails"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                        ...
                        @endif
                        @if($userEmployeeId == $approveEmployeeId)
                            @if($accComment)
    ...
    //remove second step verification div
    }
    // reviewed by update
