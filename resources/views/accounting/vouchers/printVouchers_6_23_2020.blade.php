            ...
            <div class="row firstStepVerify"  style="padding: 20px 14px 5px 14px; " id="removeSecondStepDiv">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group positionClass">
                            <p>Comment Box</p>
                            <textarea class="col-sm-12 form-groups commentStyle" name="commentsDetails" id ="reviewCommentsDetails" class="commentsDetails">{{$accComment->comments_details_verify}}</textarea>
                        </div>
                    </div>
                </div>
                {!! Form::close()  !!}
