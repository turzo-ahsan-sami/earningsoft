                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12">
                                                                {!! Form::text('voucherDatePV', null , ['class' => 'form-control softwareDate', 'id' => 'voucherDatePV','readonly'])!!}
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12">
                                                                {!! Form::text('voucherDateRV',  null, ['class' => 'form-control softwareDate', 'id' => 'voucherDateRV','readonly'])!!}
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12">
                                                                {!! Form::text('voucherDateJV', null, ['class' => 'form-control softwareDate', 'id' => 'voucherDateJV','readonly'])!!}
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12">
                                                                {!! Form::text('voucherDateCV',  null, ['class' => 'form-control softwareDate', 'id' => 'voucherDateCV','readonly'])!!}
...
$(document).ready(function(){
    ...
    $("#voucherDatePV, #voucherDateRV, #voucherDateJV, #voucherDateCV, #voucherDateFT").datepicker({
        changeMonth: true,
        changeYear: true,
        yearRange : "2016:c",
...
// ==============================Change Project(get ProjectType & ledgers) & ProjectType(get Voucher Code)==============================
            ...
            success: function (data) {
                ...
                if (check=="fromProject") {
                    if (branchId==1) {
                        ...
                        $("#projectTypeId"+idVal).prepend('<option  value="">Select Project Type</option>');
    ...
    function voucherCode(projectTypeId, voucherTypeId, branchId, idVal){
        ...
        $.ajax({
            type: 'post',
            url: './getVoucherCode',
            data: { voucherTypeId: voucherTypeId, projectTypeId: projectTypeId, branchId: branchId, _token: csrf},
            dataType: 'json',
            success: function (data) {
                // alert(JSON.stringify(data));
    ...
    $("#projectTypeIdPV, #projectTypeIdRV, #projectTypeIdJV, #projectTypeIdCV, #projectTypeIdFT").change(function () {

        if(this.id == "projectTypeIdPV") {
            var idVal="PV";
            var ideVal="PVe";
            var projectTypeId = this.value;
            var voucherTypeId=$("#debitTabValue").val();
        }else if (this.id == "projectTypeIdRV") {
            var idVal="RV";
            var ideVal="RVe";
            var projectTypeId = this.value;
            var voucherTypeId=$("#creditTabValue").val();
        }else if (this.id == "projectTypeIdJV") {
            var idVal="JV";
            var ideVal="JVe";
            var projectTypeId = this.value;
            var voucherTypeId=$("#jounalTabValue").val();
        }else if (this.id == "projectTypeIdCV") {
            var idVal="CV";
            var ideVal="CVe";
            var projectTypeId = this.value;
            var voucherTypeId=$("#contraTabValue").val();
        }else if (this.id == "projectTypeIdFT") {
            var idVal="FT";
            var ideVal="FTe";
            var projectTypeId = this.value;
        ...
        if(projectTypeId==''){
            ...
            voucherCode(projectTypeId, voucherTypeId, branchId, idVal);
        }
...
//             tableDebitAcc.push(JSON.stringify($(this).find('.debitAccInputRV').val()));
//             tableCreditAcc.push(JSON.stringify($(this).find('.creditAccInputRV').val()));
//             tableAmount.push(JSON.stringify($(this).find('.amountColumnRV').html()));
//             tableNarration.push(JSON.stringify($(this).find('.narrationRV').html()));
//         });
...
//             tableDebitAcc.push(JSON.stringify($(this).find('.debitAccInputJV').val()));
//             tableCreditAcc.push(JSON.stringify($(this).find('.creditAccInputJV').val()));
//             tableAmount.push(JSON.stringify($(this).find('.amountColumnJV').html()));
//             tableNarration.push(JSON.stringify($(this).find('.narrationJV').html()));
//         });
...
$('#addMoreCV').on('click',function(){
    ...
    //         tableDebitAcc.push(JSON.stringify($(this).find('.debitAccInputCV').val()));
    //         tableCreditAcc.push(JSON.stringify($(this).find('.creditAccInputCV').val()));
    //         tableAmount.push(JSON.stringify($(this).find('.amountColumnCV').html()));
    //         tableNarration.push(JSON.stringify($(this).find('.narrationCV').html()));
    //     });
