...
@section('title', '| Authorized Voucher')
@section('content')
        ...
        <div class="panel panel-default" style="background-color:#708090;">
            <div class="panel-heading"  style="padding-bottom:0px">
                <div class="panel-options">
                    ...
                    <a id="" href="javascript:;" class="btn btn-info pull-right addViewBtn unauthVoucher-modal <?php if(count($vouchersIdArr)==0 || ($userBranchId!=1)){echo 'disabled';}?>" data-id="-1" >
                        <span>Unauthorized All Vouchers <i class="fa fa-chevron-circle-left"></i> </span>
                    </a>
                </div>
                <h3  style=" text-align: center; font-family: Antiqua; letter-spacing: 2px; color: white;">AUTHORIZED VOUCHER LISTS</h3>
            </div>
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="col-md-2"> --}}
                                {{-- <div class="row"> --}}
                                    ...
                                    {!! Form::open(array('url' => 'authorizedVouchersList/', 'role' => 'form', 'class'=>'form-horizontal form-groups', 'id' => 'viewVoucherForm', 'method'=>'get')) !!}
                        ...
                        @foreach($vouchers as $voucher)
                            <tr class="item{{$voucher->id}}">
                                ...
                                <td class="text-center">
                                    {{-- unauthVoucher Voucher --}}
                                    <a href="javascript:;" class="unauthVoucher-modal <?php if($userBranchId!=1){ echo 'disabled';}?> " data-id="{{$voucher->id}}">
                                        <span style="font-size: 14px;color: #F00;" class="fa fa-chevron-circle-left"></span>
                                    </a>
                                </td>   {{-- Action td --}}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="infoContent" style="padding-bottom:20px;">
                    <h5>You are about to unauthenticate this voucher. This procedure is irreversible !</h5>
...
//$( "#dateTo" ).datepicker( "option", "disabled", true );
    ...
    $(document).on('click', '.unauthVoucher-modal', function() {
        ...
        $('.actionBtn').addClass('unauthVoucher');
        $('.modal-title').text('Unauthenticate Voucher');
    ...
    $('.modal-footer').on('click', '.unauthVoucher', function() {
