...
@section('title', '| Approve Budget For Asset & Liabilities')
@section('content')
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default" style="background-color:#708090;">
          ...
          <!-- Filtering Start-->
        {!! Form::open(array('url' => 'accBudgetAssetAndLiabilityRevisedApproveSubmit', 'role' => 'form', 'class'=>'form-horizontal form-groups', 'id' => 'filterFormId', 'method'=>'POST')) !!}
        {{-- @method('POST')
        @csrf --}}
            ...
            <div class="col-md-12">
                  ...
                  @if (sizeof($BudgetValues) > 0)
                    @foreach ($BudgetValues as $key1 => $BudgetValue)
                      ...
                      <tr>
                        ...
                        <input type="hidden" name="approvedDate[]" value="{{$savedDate}}">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input class="btn btn-primary" type="submit" name="Submit" value="Approve" id="reportSubmit">
                    {{-- <input class="btn btn-warning" type="reset" name="reset" value="Not Approve" onclick="window.location.href='accBudget'"> --}}
