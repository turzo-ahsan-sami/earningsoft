          ...
          <div class="panel panel-default" style="background-color:#708090;">
            <div class="panel-heading" style="padding-bottom:0px">
              <div class="panel-options">
                  <a href="{{url('addBudgetPreview')}}" class="btn btn-info pull-right addViewBtn"
                     style=""><i class="glyphicon glyphicon-plus-sign addIcon"></i>Add Budget</a>
              </div>
            ...
            <div class="panel-body panelBodyView">
                <!-- Filtering Start-->
              {!! Form::open(array('url' => 'budgetPreviewTable', 'role' => 'form', 'class'=>'form-horizontal form-groups', 'id' => 'filterFormId', 'method'=>'get')) !!}
                    ...
                    <div class="col-md-1">
                      <div class="form-group">
                        ...
                        <div class="col-md-12">
                          ...
                          <input class="btn btn-primary" type="submit" name="Submit" value="Show Budget" id="reportSubmit">
                        </div>
                      </div>
                    </div>
...
$("form").submit(function( event ) {
   ...
   $('#loadingModal').show();
   $("#reportingDiv").load('{{URL::to("budgetPreviewTable")}}'+'?'+serializeValue);
});
