    ...
    <div class="">
      <div class="panel panel-default" style="background-color:#708090;">
        <div class="panel-heading" style="padding-bottom:0px">
          ...
          <h1 align="center" style="font-family: Antiqua;letter-spacing: 2px"><font color="white">VAT BILL TYPE LIST</font></h1>
        </div>
...
*/
          ...
          <table class="table table-striped table-bordered" id="otsTable" style="color: black;">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{$count}}</td>
                        <td style="text-align:left;padding-left:15px;">{{$viewVatBillType->serviceName}}</td>
                        <td style="text-align:left;padding-left:15px;">{{$viewVatBillType->serviceCode}}</td>
