                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                         ...
                         {!! Form::label('ledger', 'Ledger:', ['class' => 'col-sm-2 control-label']) !!}
                          <div class="col-sm-4">

                            <select id="ledger" name="ledger" class="form-control" required>
    ...
    $("#billDate").datepicker({
     ...
     $("#voucherDate").datepicker({
      ...
      $("#projects").change(function(event){
        ...
        $.ajax({
          type: 'post',
          url: "./accVatRegisterGetLedgerAjax",
          data: {projectId:projectId},
            success: function (data){
             $("#ledger").empty();
              $('#ledger').append("<option value=''>--Select Ledger Type--</option>");
              console.log(data);
              $.each(data, function( key,obj){
                 $('#ledger').append("<option value='"+obj.id+"'>"+obj.code+"-"+obj.name+"</option>");
