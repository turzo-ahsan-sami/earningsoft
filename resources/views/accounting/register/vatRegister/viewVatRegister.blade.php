                    ...
                    @endif
                        ...
                        <td>
                          <a href="javascript:;" class="view-modal" vatBillTypeIdViewModal="{{$viewVatRegister->id}}">
                           ...
                           @if($viewVatRegister->status == 0)
                           <a href="javascript:;" class="pay-modal" vatBillTypeIdPayModal="{{$viewVatRegister->id}}" supplierId="{{$viewVatRegister->supplierIdFk}}" projectId="{{$viewVatRegister->projectId_Fk}}" projectTypeId="{{$viewVatRegister->project_TypeId_Fk}}" vatAmount="{{$viewVatRegister->vatAmount}}">
                                  ...
                                  <div class="form-horizontal form-groups">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-sm-8">
                                              ...
                                              {!! Form::hidden('PMprojectId', null,['id'=>'PMprojectId','class'=>'form-control','type' => 'text','autocomplete'=>'off']) !!}
                                              {!! Form::hidden('PMprojectTypeId', null,['id'=>'PMprojectTypeId','class'=>'form-control','type' => 'text','autocomplete'=>'off']) !!}
                                              {!! Form::hidden('PMsupplierId', null,['id'=>'PMsupplierId','class'=>'form-control','type' => 'text','autocomplete'=>'off']) !!}
                                  ...
                                  <div class="form-horizontal form-groups">
                                    ...
                                    <div class="form-group">
                                       {!! Form::label('accountNo', 'Account No:', ['id'=>'LaccountNo','class' => 'col-sm-4 control-label']) !!}
                                           <div class="col-sm-8">
                                            {!! Form::select('accountNo', $accountNo, null ,['id'=>'PMaccountNo','class'=>'form-control input-sm','autocomplete'=>'off', 'autofocus']) !!}
                                          </div>
                                   </div>
                                   <div class="form-group">
                                      {!! Form::label('chequeNo', 'Cheque No:', ['id'=>'LcheckNo','class' => 'col-sm-4 control-label']) !!}
                                          <div class="col-sm-8">
                                            {!! Form::text('chequeNo', null,['id'=>'PMcheckNo','class'=>'form-control','type' => 'text','autocomplete'=>'off']) !!}
                                          </div>
                                  </div>
  ...
  $(document).on('click', '.pay-modal', function() {
    $('#PMaccountNo').hide();
     ...
     $("#PMpaymentDate").datepicker({
      ...
      var pmSupplierId = $(this).attr('supplierId');
      var pmProjectId = $(this).attr('projectId');
      var pmProjectTypeId = $(this).attr('projectTypeId');
      var csrf = "{{csrf_token()}}";
    $.ajax({
    ...
    $("#PMprojectId").val(pmProjectId);
    $("#PMprojectTypeId").val(pmProjectTypeId);
    $("#PMsupplierId").val(pmSupplierId);
