                        ...
                        {!! Form::hidden('billTypeId',null,['id'=>'EMbillTypeId']) !!}
                                ...
                                <div class="col-md-6" style="padding-left:2%;">{{--2nd col-md-6--}}
                                    <div class="form-horizontal form-groups">
                                     ...
                                     <div class="form-group" id="vauchar2" style="display:none;">
                                         ...
                                         <div class="col-sm-8">
                                             {!! Form::text('vauchar', null, ['class'=>'form-control', 'id' => 'vaucharId']) !!}
                         ...
                         <div class="form-group" id="bank2" >
                             ...
                             <div class="col-sm-8" style="padding-bottom:10px;">
                                 ...
                                 @endphp
                                 <select name="bank" class="form-control input-sm" id="bankListId">
                         ...
                         <div class="form-group">
                             ...
                             <div class="col-sm-8" style="padding-bottom:10px;">
                                 {!! Form::text('advReceiveAmount',null, ['class'=>'form-control', 'id' => 'advReceiveAmount','autocomplete'=>'off','required'=>'required']) !!}
      ...
      $(document).on('click', '.receive-modal', function(){
          ...
          $('input[name="advReceiveChange"]').change(function() {
             ...
             if(receiveType=='a'){
                $("#cash2").show();
                $("#vauchar2").hide();
                $("#vaucharId").attr('required',false);
                $("#bank2").hide();
                $("#advChequeNumber").attr('required',false);
                $("#bankListId").attr('required',false);
                $("#advChequeNumber").hide();
                $("#advChequeNumberL").hide();
             }
             else if(receiveType=='b'){
               $("#vauchar2").show();
               $("#vaucharId").attr('required',true);
               $("#bank2").hide();
               $("#advChequeNumber").attr('required',false);
               $("#bankListId").attr('required',false);
               $("#cash2").hide();
              ...
              $("#bank2").show();
              $("#bankListId").attr('required',true);
              $("#advChequeNumber").attr('required',true);
