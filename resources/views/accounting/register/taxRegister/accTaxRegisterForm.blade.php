...
<div class="viewTitle" style="border-bottom: 1px solid white;">
    <a href="./accViewTaxRegister" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-th-list viewIcon">
    </i>TAX Register List</a>
</div>

<div class="panel panel-default panel-border">
	<div class="panel-heading">
	    <div class="panel-title">TAX Register</div>
	</div>
...
<div class="panel-body">
            <div class="row">
                <div class="col-md-12">
                {!! Form::open(array('url' => './accAddTaxRegister','id'=>'entryForm', 'role' => 'form', 'class'=>'form-horizontal form-groups')) !!}
                    <div class="col-md-6">
                ...
                <div class="col-md-6">
                 ...
                 <div class="form-group">
                      ...
                      <div class="col-sm-4">
                         {!! Form::text('tax', '', ['class'=>'form-control', 'id' => 'tax','readonly','required']) !!}
                            <p id='taxPara' style="max-height:3px;"></p>
                      </div>
                      <div class="col-sm-5">
                 ...
                 <div class="form-group">
                        <div class="col-sm-12 text-right">
                            ...
                            <a href="./accViewTaxRegister" class="btn btn-danger closeBtn">Close</a>
     ...
     $("#voucherDate").datepicker({
      ...
      $("#projects").click(function(event){
         var projectId=$('#projects').val();
           ...
           $.ajax({
             type: 'post',
             url: "./accTaxProjectTypeFiltering",
      ...
      $("#supplier").click(function(event){
        ...
        $.ajax({
             type: 'post',
             url: "./accTaxRegisterBillNoGenerate",
      ...
      $("#projectType").click(function(event){
        ...
        $.ajax({
             type: 'post',
             url: "./accTaxRegisterBillNoGenerateProjectType",
