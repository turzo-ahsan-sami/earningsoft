...
<div class="viewTitle" style="border-bottom: 1px solid white;">
    <a href="./accViewTaxBillType" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-th-list viewIcon">
    </i>TAX Bill Type List</a>
</div>
            ...
            <div class="row">
                ...
                {!! Form::open(array('url' => '','id'=>'entryForm', 'role' => 'form', 'class'=>'form-horizontal form-groups')) !!}
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            {!! Form::label('taxCode', 'TAX Code:', ['class' => 'col-sm-3 control-label']) !!}
                            <div class="col-sm-9">
                                {!! Form::text('taxCode', null, ['class'=>'form-control', 'id' => 'taxCode','required']) !!}
                                <p id='taxCodePara' style="max-height:3px;"></p>
                            </div>
                       </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                      {!! Form::label('taxRate', 'TAX Rate:', ['class' => 'col-sm-3 control-label']) !!}
                      <div class="col-sm-9">
                          {!! Form::number('taxRate', null, ['class'=>'form-control', 'id' => 'taxRate','required','min="0"']) !!}
                          <p id='taxRatePara' style="max-height:3px;"></p>
                      </div>
                 </div>
                  <div class="form-group">
