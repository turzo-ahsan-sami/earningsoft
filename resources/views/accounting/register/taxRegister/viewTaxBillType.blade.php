      ...
      <div class="panel panel-default" style="background-color:#708090;">
        <div class="panel-heading" style="padding-bottom:0px">
          <div class="panel-options">
              <a href="{{url('accTaxBillType/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-plus-sign addIcon"></i>ADD TAX BILL</a>
          </div>
          <h1 align="center" style="font-family: Antiqua;letter-spacing: 2px"><font color="white">TAX BILL TYPE LIST</font></h1>
        </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $(document).on('click', '.view-modal', function() {
     ...
     if(hasAccess('accViewTaxBillTypeModal')){
      var taxBillTypeId = $(this).attr('vatBillTypeId');
      var csrf = "{{csrf_token()}}";
      $.ajax({
        url: './accViewTaxBillTypeModal',
        type: 'POST',
        dataType: 'json',
        data: {taxBillTypeId: taxBillTypeId, _token: csrf},
        success: function(data) {
          ...
          $("#VMactiveFrom").val(data['viewVatBillTypes'].activeFrom);
    ...
    $(document).on('click', '.edit-modal', function() {
      ...
      var taxBillTypeId = $(this).attr('vatBillTypeIdEditModal');
  ...
  "           <td width='25%'>TAX Rate:</td>"+
  "           <td width='25%'>"+$('#VMtaxRate').val()+"</td>"+
  "       </tr>"+
  ...
  $("#hiddenTitle").hide();
    ...
    $("form").submit(function(event) {
       ...
       $.ajax({
            type: 'post',
            url: './accViewTaxBillTypeModalUpdate',
            data: $('form').serialize(),
            dataType: 'json',
