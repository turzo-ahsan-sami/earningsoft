         ...
         <div class="">
           <div class="panel panel-default" style="background-color:#708090;">
             <div class="panel-heading" style="padding-bottom:0px;">
                 ...
                 <h1 align="center" style="font-family: Antiqua;letter-spacing:2px;"><font color="white"> ADD ADVANCE REGISTER</font></h1>
             </div>
                    ...
                    <div class="modal-body">
                        ...
                        {!! Form::hidden('billTypeId',null,['id'=>'EMbillTypeId']) !!}
                            <div class="col-md-12">
                                <div class="col-md-6" style="padding-right:2%;">{{--1st col-md-6--}}
                                    <div class="form-horizontal form-groups">
                                        ...
                                        <div class="form-group">
                                       {!! Form::label('advReceiveNumber', 'Receive Id', ['class' => 'col-sm-3 control-label','style'=>'font-size:10px']) !!}
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                          {!! Form::label('project', 'Project', ['class' => 'col-sm-3 control-label','style'=>'font-size:10px']) !!}
                                            <div class="col-sm-8">
                                              {!! Form::text('project',null, ['class'=>'form-control', 'id' => 'project','readonly']) !!}
                                        ...
                                        <div class="form-group">
                                               {!! Form::label('projectType', 'Project Type', ['class' => 'col-sm-3 control-label','style'=>'font-size:10px']) !!}
                                            <div class="col-sm-8">
                                              {!! Form::text('projectTypeR',null, ['class'=>'form-control', 'id' => 'projectTypeR','readonly']) !!}
                                        ...
                                        <div class="form-group">
                                           {!! Form::label('advRegType', 'Advance Type', ['class' => 'col-sm-3 control-label','style'=>'font-size:10px']) !!}
                                            <div class="col-sm-8">

                                                  {!! Form::text('advRegTypeR',null, ['class'=>'form-control', 'id' => 'advRegTypeR','readonly']) !!}
                                                  {!! Form::hidden('advRegTypeIdHiddenR',null,['id'=>'advRegTypeIdHiddenR']) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('advPaymentId', 'Advance Payment Id', ['class' => 'col-sm-3 control-label','style'=>'font-size:10px']) !!}
                                            <div class="col-sm-8">
                                                  {!! Form::text('advPaymentIdR',null, ['class'=>'form-control', 'id' => 'advPaymentIdR','readonly']) !!}
                                        ...
                                        <div class="form-group">
                                          ...
                                          {!! Form::label('service', 'Service Catagory:', ['class' => 'col-sm-3 control-label','style'=>'font-size:10px']) !!}
                                          <div class="col-sm-8">
                                                {!! Form::text('serviceCatagoryR',null, ['class'=>'form-control', 'id' => 'serviceCatagoryR','readonly']) !!}
                                                {!! Form::hidden('serviceCatagoryIdHiddenR',null,['id'=>'serviceCatagoryIdHiddenR']) !!}
                                          </div>

                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('advRegName', 'Employee Name', ['class' => 'col-sm-3 control-label', 'style'=>'font-size:10px']) !!}

                                          <div class="col-sm-8" style="padding-bottom:10px;">


                                              {!! Form::text('advRegName', null,['class'=>'form-control','id' => 'advRegName','readonly','style'=>'cursor:pointer']) !!}
                                ...
                                <div class="col-md-6" style="padding-left:2%;">{{--2nd col-md-6--}}
                                    <div class="form-horizontal form-groups">
                                      ...
                                      <div class="form-group">
                                          {!! Form::label('paymentDate', 'Receive Date', ['class' => 'col-sm-3 control-label','style'=>'font-size:10px']) !!}

                                          <div class="col-sm-8" style="padding-bottom:10px;">
                                              {!! Form::text('paymentDate', null,['class'=>'form-control','id' => 'paymentDateR','readonly','style'=>'cursor:pointer']) !!}
                                      ...
                                      <div class="form-group">
                                          <div class="col-sm-3" style="font-size:10px">Receive Type</div>
                                     ...
                                     <div class="form-group" id="cash2" style="display:none;">
                                         {!! Form::label('cash', 'Cash', ['class' => 'col-sm-3 control-label','style'=>'font-size:10px']) !!}
                                     ...
                                     <div class="form-group" id="vauchar2" style="display:none;">
                                         {!! Form::label('vauchar', 'Vauchar Id', ['class' => 'col-sm-3 control-label','style'=>'font-size:10px']) !!}
                         ...
                         <div class="form-group" id="bank2" >
                             {!! Form::label('bank', 'Bank Name', ['class' => 'col-sm-3 control-label','style'=>'font-size:10px']) !!}
                         ...
                         <div class="form-group">
                             {!! Form::label('advReceiveAmount', 'Amount', ['class' => 'col-sm-3 control-label','style'=>'font-size:10px']) !!}
