...
@section('content')
    ...
    <?php
        ...
        // $parents=DB::table('acc_account_ledger')->where('companyIdFk', Auth::user()->company_id_fk)->where('level', ($caLevel - 1))->orderBy('code')->select('id','name','code','accountTypeId')->get();
            ...
            <div class="col-md-8 fullbody">
                ...
                <div class="panel panel-default panel-border">
                    <div class="panel-heading">
                        <div class="panel-title">Add Transaction Ledger Account</div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#code').on('blur', function() {
            ...
            $.ajax({
                type: 'post',
                url: './addLedger/checkUniqueLedgerCode',
