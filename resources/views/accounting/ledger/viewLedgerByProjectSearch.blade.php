...
<?php 
    ...
    function splitProjectBranchId($rowId){
        ...
        $projectBranchValue = DB::table('acc_account_ledger')->where('id', $rowId)->value("projectBranchId");
...
function splitProjectBranchId1($rowId, $searchedProjectId){
        ...
        $projectBranchValue = DB::table('acc_account_ledger')->where('id', $rowId)->value("projectBranchId");
            ...
            for($i=0; $i<$array_length+1; $i++){
                ...
                if($firstIndexValue==0){
                    ...
                    foreach ($projectsAll as $project){
                        // echo $project->name.' ' ;
                        array_push($arrayProjects, $project->id);
                    }
                    ...
                    if($secondIndexValue!=0){
                        ...
                        $projectBranches=DB::table('gnr_branch')->select('name')->where('projectId',$firstIndexValue)->get();                        
...
<?php
    ...
    <tr class="item{{$child->id}}">
        ...
        {{-- <td width="600" style="text-align: left; padding-left: 20px;" class="projectColumn"> --}}

            <?php 

                // $arrayProjects=splitProjectBranchId($child->id);

                // echo var_dump($arrayProjects);
                // echo $searchedProjectId;
                // echo $GLOBALS['searchedProjectId'];


                // echo "<pre>";
                // print_r($arrayProjects);
                // echo "</pre>";
                // foreach ($arrayProjects  as $arrayProjectsValue) {
                //     if($arrayProjectsValue==$searchedProjectId){
                //         echo "++++Matched+++++";
                //     }
                // }

                // if(array_search($searchedProjectId, $arrayProjects)){
                //     echo "====Matched====";
                // }
            ...
            <tbody>
              ...
              @foreach($ledgers as $ledger)
                  <?php
                      ...
                      $arrayProjects=splitProjectBranchId1($ledger->id, $searchedProjectId);
                ...
                @foreach($children1 as $child1)
                    <?php
                        ...
                        $matchValue=false;
                        $arrayProjects=splitProjectBranchId1($child1->id, $searchedProjectId);
                ...
                @foreach($children2 as $child2)
                    <?php
                        ...
                        $matchValue=false;
                        $arrayProjects=splitProjectBranchId1($child2->id, $searchedProjectId);
                ...
                @foreach($children3 as $child3)
                    <?php
                        ...
                        $matchValue=false;
                        $arrayProjects=splitProjectBranchId1($child3->id, $searchedProjectId);
                ...
                @foreach($children4 as $child4)
                    <?php
                        ...
                        $matchValue=false;
                        $arrayProjects=splitProjectBranchId1($child4->id, $searchedProjectId);
                ...
                @foreach($children5 as $child5)
                    <?php
                        ...
                        $matchValue=false;
                        $arrayProjects=splitProjectBranchId1($child5->id, $searchedProjectId);
                ...
                @foreach($children6 as $child6)
                    <?php
                        ...
                        $matchValue=false;
                        $arrayProjects=splitProjectBranchId1($child6->id, $searchedProjectId);
                ...
                @foreach($children7 as $child7)
                    <?php
                        ...
                        $matchValue=false;
                        $arrayProjects=splitProjectBranchId1($child7->id, $searchedProjectId);
                ...
                @foreach($children8 as $child8)
                    <?php
                        ...
                        $matchValue=false;
                        $arrayProjects=splitProjectBranchId1($child8->id, $searchedProjectId);
                ...
                @foreach($children9 as $child9)
                    <?php
                        ...
                        $matchValue=false;
                        $arrayProjects=splitProjectBranchId1($child9->id, $searchedProjectId);
                ...
                @foreach($children10 as $child10)
                    <?php
                        ...
                        $matchValue=false;
                        $arrayProjects=splitProjectBranchId1($child10->id, $searchedProjectId);
                        foreach ($arrayProjects  as $arrayProjectsValue) {
                            if($arrayProjectsValue==$searchedProjectId){
                                $matchValue=true;
                            }
                ...
                @foreach($children11 as $child11)
                    <?php
                        ...
                        $matchValue=false;
                        $arrayProjects=splitProjectBranchId1($child11->id, $searchedProjectId);
                ...
                @foreach($children12 as $child12)
                    <?php
                        ...
                        $matchValue=false;
                        $arrayProjects=splitProjectBranchId1($child12->id, $searchedProjectId);
                ...
                @foreach($children13 as $child13)
                    <?php
                        ...
                        $matchValue=false;
                        $arrayProjects=splitProjectBranchId1($child13->id, $searchedProjectId);
                ...
                @foreach($children14 as $child14)
                    <?php
                        ...
                        $matchValue=false;
                        $arrayProjects=splitProjectBranchId1($child14->id, $searchedProjectId);
                ...
                @foreach($children15 as $child15)
                    <?php
                        ...
                        $matchValue=false;
                        $arrayProjects=splitProjectBranchId1($child15->id, $searchedProjectId);
...
<script type="text/javascript">
    $( document ).ready(function() { 
        ...
        var filterProjectNameValue = "<?php echo $searchedProjectId;?>";
        $('#filterProjectName').val(filterProjectNameValue);        
