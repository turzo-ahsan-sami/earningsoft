    ...
    <div class="col-md-12">
        ...
        <div class="col-md-8 fullbody">
            <div class="viewTitle" style="border-bottom: 1px solid white;">
                <a href="{{url($preRouteName)}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-th-list viewIcon">
                </i>Ledger List</a>
            </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            @if ($preRouteName != 'viewTransactionLedger')
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 text-right" >
                                    ...
                                    <a href="{{url($preRouteName)}}" class="btn btn-danger closeBtn">Close</a>
...
<div id="myModal" class="modal fade" style="margin-top:3%" data-backdrop="static" data-keyboard="false">
    ...
    return false;
            ...
            window.location.href = '{{url($preRouteName)}}';
