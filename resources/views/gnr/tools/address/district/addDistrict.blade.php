		...
		<div class="col-md-12">
            <div class="col-md-8 col-md-offset-2 fullbody">
            	<div class="viewTitle" style="border-bottom:1px solid white;">
                    <a href="{{ url($route['path'].'/viewDistrict/') }}" class="btn btn-info pull-right addViewBtn">
                ...
                <div class="panel panel-default panel-border">
                	<div class="panel-heading">
                        <div class="panel-title">New District</div>
                    </div>
                        		...
                        		{!! Form::open(array('url' => '', 'role' => 'form', 'class' => 'form-horizontal form-groups')) !!}
                        			...
                        			<div class="form-group">
                        				<div class="col-sm-10 col-sm-offset-2">
                        					...
                        					<a href="{{ url($route['path'].'/viewDistrict/') }}" class="btn btn-danger closeBtn">Close</a>
                        				</div>
                        			</div>
                        		{!! Form::close() !!}
                            </div>
