      ...
      <div class="panel panel-default" style="background-color:#708090;">
        <div class="panel-heading" style="padding-bottom:0px">
          <div class="panel-options">
              <a href="{{url($route['path'].'/addVillage/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-plus-sign addIcon"></i>Add Village</a>
          </div>
                ...
                <tbody> 
                  ...
                  @foreach($villages as $village)
                    <tr class="item{{$village->id}}">
                      ...
                      <td style='text-align: left; padding-left: 5px;'>
                          <?php
                            $upzillaName = DB::table('gnr_upzilla')->select('name')->where('id',$village->upzillaId)->first();
                          ?>
