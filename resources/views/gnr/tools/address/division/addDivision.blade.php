		...
		<div class="col-md-12">
            <div class="col-md-8 col-md-offset-2 fullbody">
            	<div class="viewTitle" style="border-bottom:1px solid white;">
                    <a href="{{ url($route['path'].'/viewDivision/') }}" class="btn btn-info pull-right addViewBtn">
                        		...
                        		{!! Form::open(array('url' => '', 'role' => 'form', 'class' => 'form-horizontal form-groups')) !!}
                        			...
                        			<div class="form-group">
                        				<div class="col-sm-10 col-sm-offset-2">
                        					...
                        					<a href="{{ url($route['path'].'/viewDivision/') }}" class="btn btn-danger closeBtn">Close</a>
                        				</div>
                        			</div>
                        		{!! Form::close() !!}
                            </div>
            ...
            $.ajax({
                ...
                success: function(_response) {
                    if(_response.errors) {
                        ...
                        setTimeout(function(){
                            window.location.href = '{{ url($route['path'].'/viewDivision/') }}';
                        }, 3000);
                    }
                },
