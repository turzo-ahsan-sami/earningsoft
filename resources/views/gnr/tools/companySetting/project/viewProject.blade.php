            ...
            <table class="table table-striped table-bordered" id="gnrProjectView">
              ...
              <tbody>
                ...
                <tr class="item{{$project->id}}">
                  ...
                  // $canDelete = 1;
                  // }
                  $voucherId = DB::table('acc_voucher')->where('companyId',Auth::user()->company_id_fk)->where('projectId',$project->id)->value('id');
                  
                  //dd($voucher);
                  @endphp
                    <a href="javascript:;" class="delete-modal" data-id="{{$project->id}}" data-voucherId="{{$voucherId}}">
