            ...
            <div class="col-md-8 fullbody">
                ...
                <div class="panel panel-default panel-border">
                    <div class="panel-heading">
                        <div class="panel-title">Edit Responsibility</div>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-8">
                                    {!! Form::open(array('url' => route('gnrResponsibility.update')."?id={$responsibility->id}", 'role' => 'form', 'class'=>'form-horizontal form-groups')) !!}
                                    <div class="form-group">
                                        {!! Form::label('position_id_fk', 'Position : ', ['class' => 'col-sm-4 control-label']) !!}
                                        <div class="col-sm-8">
                                            {!! Form::select('position_id_fk', $positions, $responsibility->position_id_fk, ['class' => 'form-control','id'=>'position', 'autocomplete'=>'off']) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            Yes {!! Form::radio('employee_specify','Yes',!empty($responsibility->emp_id_fk) ? true : false , ['class' => 'employee-specify', 'autocomplete'=>'off']) !!}
                                            <span style="padding: 0 2px;"></span>
                                            No {!! Form::radio('employee_specify','No',empty($responsibility->emp_id_fk) ? true : false , ['class' => 'employee-specify', 'autocomplete'=>'off']) !!}
                                        </div>
                                    </div>

                                    <div class="form-group employee-container" style="display: {{ empty($responsibility->emp_id_fk) ? 'none' : '' }};">
                                        {!! Form::label('emp_id_fk', 'Employee : ', ['class' => 'col-sm-4 control-label']) !!}
                                        <div class="col-sm-8">
                                            {!! Form::select('emp_id_fk', $employeeList, $responsibility->emp_id_fk ?? null, ['class' => 'form-control','id'=>'employee', 'autocomplete'=>'off']) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select('type_code', $responsibleBoundaries, $responsibility->type_code, ['class' => 'form-control','id'=>'type-code', 'autocomplete'=>'off']) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select('id_list[]', $boundaryList, json_decode($responsibility->id_list), ['class' => 'form-control select2','id'=>'boundary', 'multiple','autocomplete'=>'off']) !!}
