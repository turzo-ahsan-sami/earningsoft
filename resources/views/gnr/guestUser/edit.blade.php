            ...
            <div class="col-md-8 fullbody">
                ...
                <div class="panel panel-default panel-border">
                    <div class="panel-heading">
                        <div class="panel-title">Edit Guest User</div>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-8">
                                    {!! Form::open(array('url' => route('guestUser.update', $user->id), 'role' => 'form', 'class'=>'form-horizontal form-groups')) !!}
                                    <div class="form-group">
                                        {!! Form::label('name', 'Name : ', ['class' => 'col-sm-4 control-label']) !!}
                                        <div class="col-sm-8">
                                            {!! Form::text('name', $user->name ?? '', ['class' => 'form-control','id'=>'name', 'autocomplete'=>'off','placeholder' => 'Enter Full Name']) !!}
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::text('user_name', $user->username ?? '', ['class' => 'form-control','id'=>'user_name', 'autocomplete'=>'off', 'placeholder' => 'Enter User Name']) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::text('email', $user->email ?? '', ['class' => 'form-control', 'id' => 'email','autocomplete'=>'off','placeholder' => 'Enter Email']) !!}
                                            @if ($errors->has('email'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select('role',$roles, $user->getRole()->roleId ?? null, ['class' => 'form-control', 'id' => 'role', 'placeholder' => 'Select Role']) !!}
                                            @if ($errors->has('role'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select('company',$companies, $user->company_id_fk ?? null, ['class' => 'form-control', 'id' => 'company', 'placeholder' => 'Select Company']) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select('project',$projects,$user->project_id_fk ?? null, ['class' => 'form-control', 'id' => 'project', 'placeholder' => 'Select Project']) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select('branch',$branches, $user->branchId ?? null, ['class' => 'form-control', 'id' => 'branch', 'placeholder' => 'Select Branch']) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select('status',[0=>'Inactive',1=>'Active'], $user->status ?? null, ['class' => 'form-control', 'autocomplete'=>'off','placeholder' => 'Select Branch']) !!}
