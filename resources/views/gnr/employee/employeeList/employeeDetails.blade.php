                ...
                <div class="panel panel-default" style="background-color:#708090;">
                    <div class="panel-heading" style="padding-bottom:0px">
                        <div class="panel-options">
                            <a href="{{url($route['path'].'/posHrEmployeeList/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-plus-sign addIcon"></i>All Employee</a>
                        </div>
                              ...
                              <div class="col-md-6"> 
                                <table class="table table-striped table-bordered" id="" style="color:black;">
                                    <tr><th><u>Personal Information:</u></th><td></td><td></td></tr>
                                        ...
                                        <tr>
                                            <th>Image</th><td>:</td><td><img src="{{ asset("images/employee/$hrAllEmployeeDetails->image") }}" width="60"></td>
                                        </tr>
                                        {{ csrf_field() }}
                                </table>
                            </div>
