                ...
                <div class="panel panel-default" style="background-color:#708090;">
                    <div class="panel-heading" style="padding-bottom:0px">
                        <div class="panel-options">
                            <a href="{{url($route['path'].'/posAddHrEmployee/')}}" class="btn btn-info pull-right addViewBtn"><i class="glyphicon glyphicon-plus-sign addIcon"></i>Add Employee</a>
                        </div>
                        <?php
                            /*echo '<pre>';
                    ...
                    <div class="panel-body panelBodyView">
                        ...
                        <div class="col-md-12" style="background-color: #ffff; padding:10px;">
                           ...
                           <!--  <div class="col-md-2">
                                <input class="form-control" placeholder="Employee Id" name="filter_name_or_id" id="filter_name_or_id" type="text" value="<?php if(isset($_GET['filter_name_or_id'])) echo $filter_name_or_id; ?>">
                            </div> -->
                           <!--  <div class="col-md-1">
                       ...
                       <div class="clearfix">&nbsp;</div>
                        ...
                        <table class="table table-striped table-bordered" id="HrEmployee" style="color:black;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                <td class="text-center" width="50px">{{($pageNo-1)*15+($key+1)}}</td>
                                <td class="text-left" style="text-align: left; padding: 5px;">{{$hrAllEmployeeInfo->name}}</td>
                                <td class="text-left">{{$hrAllEmployeeInfo->employeeId}}</td>
                                <?php 
                                    $branchName = DB::table('gnr_branch')->where('id',$hrAllEmployeeInfo->branchId)->value('name');
                                ?>
                                <td style="text-align: left; padding-left: 5px;">{{$branchName}}</td>
                                 <?php 
                                    $departmentName = DB::table('gnr_department')->where('id',$hrAllEmployeeInfo->department_id_fk)->value('name');
                                ?>
                                <td style="text-align: left; padding-left: 5px;">{{$departmentName}}</td>
                                <?php 
                                    $positionName = DB::table('gnr_position')->where('id',$hrAllEmployeeInfo->position_id_fk)->value('name');
                                ?>
                                <td style="text-align: left; padding-left: 5px;">{{$positionName}}</td>
                                ...
                                <td>
                                    <?php
                                        if($hrAllEmployeeInfo->status =='1'){
                                        echo '<i class="fa fa-check"></i>';
                                        } else if ($hrAllEmployeeInfo->status =='0') {
                                          echo '<i class="fa fa-exclamation-circle"></i>';  
                                        }
                                     ?>
                                </td>
                               {{--  <td class="text-center"><img src="{{ asset("images/employee/$hrAllEmployeeInfo->image") }}" width="60" height="50"> --}}
                                   
                                </td>

                                <td>

                                <a href="{{url($route['path'].'/hrDetailsEmployee/').'/'.$hrAllEmployeeInfo->id}}"><i class="fa fa-eye"></i></a>
                                <a id="editIcone" href="{{url($route['path'].'/hrEditEmployee/').'/'.$hrAllEmployeeInfo->id}}"><i class="fa fa-pencil"></i></a>
                                <a href="javascript:;"  deleteemployeeid="{{$hrAllEmployeeInfo->id}}" class="delete-modal"><i class="fa fa-times"></i>
                                </a>
                                </td>
                                </tr>
                                @endforeach 
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <?php 
                                                            $gnrpositions = array('' => 'Select any') + DB::table('gnr_position')->pluck('name','id')->all(); 
                                                            ?>      
  ...
  if(/^image/.test(files[0].type)){
    ...
    /*Edit Modal Start*/
        $(document).on('click', '.edit-modal', function() {
            ...
            //alert(epmloyeeId);
            var csrf = "{{csrf_token()}}";
            //if(hasAccess('updateHrEployeeInfo')){
    ...
    $('#updateForm').submit(function(event) {
            ...
            .done(function(data) {
                if(data.errors)  {
                    ...
                    window.location.href = '{{url('posHrEmployeeList/') }}';
                }
            });
