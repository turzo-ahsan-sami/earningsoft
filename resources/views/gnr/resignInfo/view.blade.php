                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-bordered table-condensed">
                                            ...
                                            <tr>
                                                <th class="text-left"><?= $data['attributes']['resign_date']?>:</th>
                                                <td><?= ($data['model']->resign_date!=Null)?date('d-m-Y',strtotime($data['model']->resign_date)):''?></td>

                                                <th class="text-left"><?= $data['attributes']['expected_effect_date']?>:</th>
                                                <td><?= ($data['model']->expected_effect_date!=Null)?date('d-m-Y',strtotime($data['model']->expected_effect_date)):''?></td>
                                            </tr>
                                    ...
                                    <div class="col-md-12 text-center">
                                        <a class="btn btn-info btn-sm" href="<?= url('hr/resignInfo/approved/'.$data['model']->id)?>">Approved</a>
                                    </div>
