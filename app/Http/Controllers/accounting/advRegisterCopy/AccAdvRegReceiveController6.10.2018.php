...
//    }
   ...
   if($request->serviceCatagoryIdHiddenR==1) {
       $totalAmount=(float)DB::table('acc_adv_register')->where('projectId',$request->projectIdR)->where('projectTypeId',$request->projectTypeIdHiddenR)->where('advRegType',$request->advRegTypeIdHiddenR)->where('houseOwnerId',$request->advRegNameIdHiddenR)->sum('amount');

       $reciveAmount=DB::table('acc_adv_receive')->where('projectId',$request->projectIdR)->where('projectTypeId',$request->projectTypeIdHiddenR)->where('regTypeId',$request->advRegTypeIdHiddenR)->where('houseOwnerId',$request->advRegNameIdHiddenR)->sum('amount');

       $payableAmount =$totalAmount-$reciveAmount;

       $totalAdvNos=AccAdvRegister::where('projectId',$request->projectIdR)->where('projectTypeId',$request->projectTypeIdHiddenR)->where('advRegType',$request->advRegTypeIdHiddenR)->where('houseOwnerId',$request->advRegNameIdHiddenR)->get();
     ...
     $totalAmount=(float) DB::table('acc_adv_register')->where('projectId',$request->projectIdR)->where('projectTypeId',[$request->projectTypeIdHiddenR])->where('advRegType',$request->advRegTypeIdHiddenR)->where('supplierId',$request->advRegNameIdHiddenR)->sum('amount');

     $reciveAmount=DB::table('acc_adv_receive')->where('projectId',$request->projectIdR)->where('projectTypeId',$request->projectTypeIdHiddenR)->where('regTypeId',$request->advRegTypeIdHiddenR)->where('supplierId',$request->advRegNameIdHiddenR)->sum('amount');

     $payableAmount =$totalAmount-$reciveAmount;

     $totalAdvNos=AccAdvRegister::where('projectId',$request->projectIdR)->where('projectTypeId',$request->projectTypeIdHiddenR)->where('advRegType',$request->advRegTypeIdHiddenR)->where('supplierId',$request->advRegNameIdHiddenR)->get();
     ...
     $totalAmount=(float)DB::table('acc_adv_register')->where('projectId',$request->projectIdR)->where('projectTypeId',$request->projectTypeIdHiddenR)->where('advRegType',$request->advRegTypeIdHiddenR)->where('employeeId',$request->advRegNameIdHiddenR)->sum('amount');

     $reciveAmount=(float)DB::table('acc_adv_receive')->where('projectId',$request->projectIdR)->where('projectTypeId',$request->projectTypeIdHiddenR)->where('regTypeId',$request->advRegTypeIdHiddenR)->where('employeeId',$request->advRegNameIdHiddenR)->sum('amount');

     $payableAmount =$totalAmount-$reciveAmount;

     $totalAdvNos=AccAdvRegister::where('projectId',$request->projectIdR)->where('projectTypeId',$request->projectTypeIdHiddenR)->where('advRegType',$request->advRegTypeIdHiddenR)->where('employeeId',$request->advRegNameIdHiddenR)->get();
