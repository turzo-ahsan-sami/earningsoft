...
/*---------------------View List -----------------------------*/
    ...
    public function viewAdvRegisterListReceiveModal(Request $request)
    {
      ...
      if($accAdvRegister->employeeId) {
        ...
        $totalAmount=(float)DB::table('acc_adv_register')->where('projectId',$project->id)->where('projectTypeId',$projectType->id)->where('advRegType',$registerType->id)->where('employeeId',$resultId)->sum('amount');

        $reciveAmount=DB::table('acc_adv_receive')->where('projectId',$project->id)->where('projectTypeId',$projectType->id)->where('regTypeId',$registerType->id)->where('employeeId',$resultId)->sum('amount');
      ...
      elseif($accAdvRegister->supplierId) {
        ...
        $totalAmount=(float)DB::table('acc_adv_register')->where('projectId',$project->id)->where('projectTypeId',$projectType->id)->where('advRegType',$registerType->id)->where('supplierId',$resultId)->sum('amount');

        $reciveAmount=DB::table('acc_adv_receive')->where('projectId',$project->id)->where('projectTypeId',$projectType->id)->where('regTypeId',$registerType->id)->where('supplierId',$resultId)->sum('amount');
      ...
      elseif($accAdvRegister->houseOwnerId) {
        ...
        $totalAmount=(float)DB::table('acc_adv_register')->where('projectId',$project->id)->where('projectTypeId',$projectType->id)->where('advRegType',$registerType->id)->where('houseOwnerId',$resultId)->sum('amount');

        $reciveAmount=DB::table('acc_adv_receive')->where('projectId',$project->id)->where('projectTypeId',$projectType->id)->where('regTypeId',$registerType->id)->where('houseOwnerId',$resultId)->sum('amount');
