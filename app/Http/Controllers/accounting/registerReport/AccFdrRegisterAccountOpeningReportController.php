...
class AccFdrRegisterAccountOpeningReportController extends Controller
{
	public function index(Request $request){         
     ...
     $fdrAccounts = DB::table('acc_fdr_account');
      ...
      $bankNames = $bankNames->pluck('bankName','bankName')->toArray();
      $bankBranchLocations = $bankBranchLocations->pluck('bankBranchLocation','bankBranchLocation')->toArray();

      $fdrAccounts = $fdrAccounts->get();  

      

      return view('accounting.registerReport.fdr.fdrRegisterAccountOpeningReport',['fdrAccounts'=>$fdrAccounts,'projects'=>$projects,'projectTypes'=>$projectTypes,'branches'=>$branches,'fdrTypes'=>$fdrTypes,'bankNames'=>$bankNames,'bankBranchLocations'=>$bankBranchLocations]);      
    }
