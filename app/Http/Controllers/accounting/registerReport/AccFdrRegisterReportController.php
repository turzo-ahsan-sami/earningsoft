	...
	public function index(Request $request){         
     ...
     $fdrAccounts = DB::table('acc_fdr_account');
      ...
      if ($request->dateFrom!=null && $request->dateTo!=null) {
        ...
        $fdrAccounts = $fdrAccounts/*->where('openingDate','>=',$startDate)*/->where('openingDate','<=',$endDate)->whereNotIn('id',$closingAccountIdsBeforeStartDate);
      }
      else{
        $startDate = null;
        $endDate = null;
      ...
      return view('accounting.registerReport.fdr.fdrRegisterReport', $data);      
    }
