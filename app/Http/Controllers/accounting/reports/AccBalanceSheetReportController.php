...
class AccBalanceSheetReportController extends Controller
{

 	public function balanceSheet(Request $request){
		$ledgers = DB::table('acc_account_ledger')->whereIn('accountTypeId',[1,6,9])->where('parentId',0)->orderBy('ordering', 'asc')->get();
		...
		return view('accounting.reports.balanceSheet',$data);
