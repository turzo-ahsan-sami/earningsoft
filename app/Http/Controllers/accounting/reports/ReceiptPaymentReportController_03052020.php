...
class ReceiptPaymentReportController extends Controller{
    ...
    public function receiptPaymentLoadReport(Request $request) {
        ...
        // dd($yearBeforePreviousYearId, $previousFiscalYearId, $thisFiscalYearId);

        // ledgers variable and collection
        $cashLedgerTypeId = 4;
        $bankLedgerTypeId = 5;
        $cashNBankBalanceLedgerIdArr = [285];
        ...
        elseif ($searchType == 2) {
            ...
            if ($project != "0") {
                $thisMonthOpeningCashDebit->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $thisMonthOpeningCashDebit->where('acc_voucher.projectTypeId', $projectType);
            }
            ...
            if ($project != "0") {
                $thisMonthOpeningCashCredit->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $thisMonthOpeningCashCredit->where('acc_voucher.projectTypeId', $projectType);
            }
            ...
            if ($project != "0") {
                $thisMonthOpeningBankDebit->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $thisMonthOpeningBankDebit->where('acc_voucher.projectTypeId', $projectType);
            }
            ...
            if ($project != "0") {
                $thisMonthOpeningBankCredit->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $thisMonthOpeningBankCredit->where('acc_voucher.projectTypeId', $projectType);
            }
            ...
            if ($project != "0") {
                $thisMonthBankDebit->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $thisMonthBankDebit->where('acc_voucher.projectTypeId', $projectType);
            }
            ...
            if ($project != "0") {
                $thisMonthBankCredit->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $thisMonthBankCredit->where('acc_voucher.projectTypeId', $projectType);
            }
            ...
            if ($project != "0") {
                $thisMonthPayment->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $thisMonthPayment->where('acc_voucher.projectTypeId', $projectType);
            }
            // voucher type condition apply
            if ($voucherType == 0) {
                $thisMonthPayment->where('acc_voucher.voucherTypeId', '!=', 3)->whereIn('acc_voucher_details.creditAcc', $cashNBankLedgerIdArr);
            }
            elseif ($voucherType == 1) {
                $thisMonthPayment->where(function($q) use($cashNBankLedgerIdArr) {
                    $q->whereIn('acc_voucher_details.creditAcc', $cashNBankLedgerIdArr)
                        ->orWhere('acc_voucher.voucherTypeId', 3);
                });
            }
            elseif ($voucherType == 2) {
                $thisMonthPayment->where('acc_voucher.voucherTypeId', 3);
            }
            ...
            if ($project != "0") {
                $thisMonthReceipt->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $thisMonthReceipt->where('acc_voucher.projectTypeId', $projectType);
            }
            // voucher type condition apply
            if ($voucherType == 0) {
                $thisMonthReceipt->where('acc_voucher.voucherTypeId', '!=', 3)->whereIn('acc_voucher_details.debitAcc', $cashNBankLedgerIdArr);
            }
            elseif ($voucherType == 1) {
            ...
            elseif ($voucherType == 2) {
                $thisMonthReceipt->where('acc_voucher.voucherTypeId', 3);
            }
            ...
            if ($project != "0") {
                $thisYearPayment->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $thisYearPayment->where('acc_voucher.projectTypeId', $projectType);
            }
            // voucher type condition apply
            if ($voucherType == 0) {
                $thisYearPayment->where('acc_voucher.voucherTypeId', '!=', 3)->whereIn('acc_voucher_details.creditAcc', $cashNBankLedgerIdArr);
            }
            elseif ($voucherType == 1) {
            ...
            elseif ($voucherType == 2) {
                $thisYearPayment->where('acc_voucher.voucherTypeId', 3);
            }
            ...
            if ($project != "0") {
                $thisYearReceipt->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $thisYearReceipt->where('acc_voucher.projectTypeId', $projectType);
            }
            // voucher type condition apply
            if ($voucherType == 0) {
                $thisYearReceipt->where('acc_voucher.voucherTypeId', '!=', 3)->whereIn('acc_voucher_details.debitAcc', $cashNBankLedgerIdArr);
            }
            elseif ($voucherType == 1) {
            ...
            elseif ($voucherType == 2) {
                $thisYearReceipt->where('acc_voucher.voucherTypeId', 3);
            }
            ...
            //=============================cumulative data=================================
            // $branchLists = DB::table('gnr_branch')->whereIn('id', $branchIdArr)->pluck('aisStartDate', 'id')->toArray();
            // // dd($branchLists);
            // $manualOpeningBalanceCollection = collect();
            //
            ...
            //
            //     foreach ($manualOpeningBalanceData as $ledgerId => $item) {
            //
            //         $manualOpeningBalanceCollection->push([
            //             'ledgerId'  => $ledgerId,
            //             'cashDebit' => $item->cashDebit,
            //             'cashDebit' => $item->cashCredit
            //         ]);
            //     }
            //
            // }
        ...
        elseif ($searchType == 3) {
            ...
            $dateRangeOpeningCashDebit = DB::table('acc_voucher')
                                        ...
                                        // ->where('acc_voucher.projectId', $project)
                                        ->whereIn('acc_voucher.branchId', $branchIdArr)
                                        ->where('acc_voucher.voucherDate', '>', $lastYearEndDate)
                                        ->where('acc_voucher.voucherDate', '<', $dateFrom)
                                        ->whereIn('acc_voucher_details.debitAcc', $cashLedgerIdArr);

            if ($project != "0") {
                $dateRangeOpeningCashDebit->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $dateRangeOpeningCashDebit->where('acc_voucher.projectTypeId', $projectType);
            }
            ...
            if ($project != "0") {
                $dateRangeOpeningCashCredit->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $dateRangeOpeningCashCredit->where('acc_voucher.projectTypeId', $projectType);
            }
            ...
            if ($project != "0") {
                $dateRangeOpeningBankDebit->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $dateRangeOpeningBankDebit->where('acc_voucher.projectTypeId', $projectType);
            }
            ...
            if ($project != "0") {
                $dateRangeOpeningBankCredit->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $dateRangeOpeningBankCredit->where('acc_voucher.projectTypeId', $projectType);
            }
            ...
            if ($project != "0") {
                $dateRangeCashDebit->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $dateRangeCashDebit->where('acc_voucher.projectTypeId', $projectType);
            }
            ...
            if ($project != "0") {
                $dateRangeCashCredit->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $dateRangeCashCredit->where('acc_voucher.projectTypeId', $projectType);
            }
            ...
            if ($project != "0") {
                $dateRangeBankDebit->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $dateRangeBankDebit->where('acc_voucher.projectTypeId', $projectType);
            }
            ...
            if ($project != "0") {
                $dateRangeBankCredit->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $dateRangeBankCredit->where('acc_voucher.projectTypeId', $projectType);
            }
            ...
            if ($project != "0") {
                $dateRangeReceipt->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $dateRangeReceipt->where('acc_voucher.projectTypeId', $projectType);
            }
            // voucher type condition apply
            if ($voucherType == 0) {
                $dateRangeReceipt->where('acc_voucher.voucherTypeId', '!=', 3)->whereIn('acc_voucher_details.debitAcc', $cashNBankLedgerIdArr);
            }
            elseif ($voucherType == 1) {
            ...
            elseif ($voucherType == 2) {
                $dateRangeReceipt->where('acc_voucher.voucherTypeId', 3);
            }
            ...
            if ($project != "0") {
                $dateRangePayment->where('acc_voucher.projectId', $project);
            }
            if ($projectType != "0") {
                $dateRangePayment->where('acc_voucher.projectTypeId', $projectType);
            }
            // voucher type condition apply
            if ($voucherType == 0) {
                $dateRangePayment->where('acc_voucher.voucherTypeId', '!=', 3)->whereIn('acc_voucher_details.creditAcc', $cashNBankLedgerIdArr);
            }
            elseif ($voucherType == 1) {
            ...
            elseif ($voucherType == 2) {
                $dateRangePayment->where('acc_voucher.voucherTypeId', 3);
            }
