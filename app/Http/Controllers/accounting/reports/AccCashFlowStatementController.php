...
class AccCashFlowStatementController extends Controller{
    ...
    public function cashFlowStatementLoadTable(Request $request) {
        ...
        elseif ($searchType == 2) {
            // =================================== year-end data ================================================
            // income
            $yearEndIncome = DB::table($acc_opening_balance)->where('companyIdFk', $user_company_id)
                            ->whereIn('ledgerId', $finalLevelIncomeLedgerIdArr)
                            ->whereIn('branchId', $branchIdArr)
                            // ->where('projectId', $project)
            ...
            $yearEndIncome = $yearEndIncome->select(
                                            ...
                                            ->first();
            // expense
            $yearEndExpense = DB::table($acc_opening_balance)->where('companyIdFk', $user_company_id)
                            ->whereIn('ledgerId', $finalLevelExpenseLedgerIdArr)
                            ->whereIn('branchId', $branchIdArr)
                            // ->where('projectId', $project)
                            ->where('fiscalYearId', $previousFiscalYearId);
            ...
            // project filter
            if ($project != "0") {
                $thisYearIncomeDebit->where('av.projectId', $project);
            }
            // project type filter
            if ($projectType != "0") {
                $thisYearIncomeDebit->where('av.projectTypeId', $projectType);
            }
            ...
            // project filter
            if ($project != "0") {
                $thisYearIncomeCredit->where('av.projectId', $project);
            }
            // project type filter
            if ($projectType != "0") {
                $thisYearIncomeCredit->where('av.projectTypeId', $projectType);
            }
            ...
            // project filter
            if ($project != "0") {
                $thisYearExpenseDebit->where('av.projectId', $project);
            }
            // project type filter
            if ($projectType != "0") {
                $thisYearExpenseDebit->where('av.projectTypeId', $projectType);
            }
            ...
            // project filter
            if ($project != "0") {
                $thisYearExpenseCredit->where('av.projectId', $project);
            }
            // project type filter
            if ($projectType != "0") {
                $thisYearExpenseCredit->where('av.projectTypeId', $projectType);
            }
            ...
            // project filter
            if ($project != "0") {
                $thisMonthIncomeDebit->where('av.projectId', $project);
            }
            // project type filter
            if ($projectType != "0") {
                $thisMonthIncomeDebit->where('av.projectTypeId', $projectType);
            }
            ...
            // project filter
            if ($project != "0") {
                $thisMonthIncomeCredit->where('av.projectId', $project);
            }
            // project type filter
            if ($projectType != "0") {
                $thisMonthIncomeCredit->where('av.projectTypeId', $projectType);
            }
            ...
            // project filter
            if ($project != "0") {
                $thisMonthExpenseDebit->where('av.projectId', $project);
            }
            // project type filter
            if ($projectType != "0") {
                $thisMonthExpenseDebit->where('av.projectTypeId', $projectType);
            }
            ...
            // project filter
            if ($project != "0") {
                $thisMonthExpenseCredit->where('av.projectId', $project);
            }
            // project type filter
            if ($projectType != "0") {
                $thisMonthExpenseCredit->where('av.projectTypeId', $projectType);
            }
        ...
        elseif ($searchType == 2) {
            // =================================== year-end data ================================================
            $yearEndData = DB::table($acc_opening_balance)->where('companyIdFk', $user_company_id)
                            ->whereIn('ledgerId', $finalLevelCashFlowLedgersIdArr)
                            ->whereIn('branchId', $branchIdArr)
                            // ->where('projectId', $project)
                            ->where('fiscalYearId', $previousFiscalYearId);
            ...
            // project filter
            if ($project != "0") {
                $thisYearNonCashDebit->where('av.projectId', $project);
            }
            // project type filter
            if ($projectType != "0") {
                $thisYearNonCashDebit->where('av.projectTypeId', $projectType);
            }
            ...
            // project filter
            if ($project != "0") {
                $thisYearCashDebit->where('av.projectId', $project);
            }
            // project type filter
            if ($projectType != "0") {
                $thisYearCashDebit->where('av.projectTypeId', $projectType);
            }
            ...
            // project filter
            if ($project != "0") {
                $thisYearNonCashCredit->where('av.projectId', $project);
            }
            // project type filter
            if ($projectType != "0") {
                $thisYearNonCashCredit->where('av.projectTypeId', $projectType);
            }
            ...
            // project filter
            if ($project != "0") {
                $thisYearCashCredit->where('av.projectId', $project);
            }
            // project type filter
            if ($projectType != "0") {
                $thisYearCashCredit->where('av.projectTypeId', $projectType);
            }
            ...
            // project filter
            if ($project != "0") {
                $thisMonthNonCashDebit->where('av.projectId', $project);
            }
            // project type filter
            if ($projectType != "0") {
                $thisMonthNonCashDebit->where('av.projectTypeId', $projectType);
            }
            ...
            // project filter
            if ($project != "0") {
                $thisMonthNonCashCredit->where('av.projectId', $project);
            }
            // project type filter
            if ($projectType != "0") {
                $thisMonthNonCashCredit->where('av.projectTypeId', $projectType);
            }
        ...
        if ($searchType == 1) {
            // op balance cash
            $opBalanceCashNBank = DB::table($acc_opening_balance)->where('companyIdFk', $user_company_id)
        ...
        elseif ($searchType = 2) {
            ...
            // project filter
            if ($project != "0") {
                $thisMonthOpeningCashNBankDebit->where('av.projectId', $project);
            }
            // project type filter
            if ($projectType != "0") {
                $thisMonthOpeningCashNBankDebit->where('av.projectTypeId', $projectType);
            }
            ...
            // project filter
            if ($project != "0") {
                $thisMonthOpeningCashNBankCredit->where('av.projectId', $project);
            }
            // project type filter
            if ($projectType != "0") {
                $thisMonthOpeningCashNBankCredit->where('av.projectTypeId', $projectType);
            }
