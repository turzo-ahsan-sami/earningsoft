        ...
        $tableType=0;
            ...
            $subTotalCreditAmountEmp =0;
                        ...
                        {   if($generateEmployees[$x] !=0){
                            ...
                            $collectionsAll[] =collect(["openningBalance" => $resultOpenEmployee,"id" => $generateEmployees[$x],"amount" => $advanceAmountTotalSumEmployee,"payment" =>$advancePaymentTotalSumEmployee,"closingBalance" => $resultCloseEmployee]);
                        }
                      }
            ...
            {   if($generateSuppliers[$x] !=0){
                ...
                $collectionsAll[] =collect(["openningBalance" => $resultOpenSupplier,"id" => $generateSuppliers[$x],"amount" => $advanceAmountTotalSumSupplier,"payment" =>$advancePaymentTotalSumSupplier,"closingBalance" => $resultCloseSupplier]);
