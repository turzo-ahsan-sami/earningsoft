...
class AccCashFlowsController extends Controller{
    ...
    public function cashFlows(Request $request){
        ...
        return view('accounting.reports.cashFlows',['user_branch_id' => $user_branch_id, 'user_company_id' => $user_company_id,'user_project_id' => $user_project_id,'user_project_type_id' => $user_project_type_id,'projects' => $projects, 'projectTypes' => $projectTypes, 'branches' => $branches, 'fiscalYears' => $fiscalYears, 'searchedProjectId' => $searchedProjectId, 'searchedProjectTypeId' => $searchedProjectTypeId, 'searchedBranchId' => $searchedBranchId, 'searchedDepthLevel' => $searchedDepthLevel, 'searchedRoundUp' => $searchedRoundUp, 'searchedWithZero' => $searchedWithZero, 'searchedSearchMethod' => $searchedSearchMethod, 'searchedFiscalYearId' => $searchedFiscalYearId, 'searchedDateFrom' => $searchedDateFrom, 'searchedDateTo' => $searchedDateTo, 'projectSelected' => $projectSelected, 'projectTypeSelected' => $projectTypeSelected, 'branchSelected' => $branchSelected ]);
