...
//        AddVoucher::where('id',$rowId)->delete();
    ...
    public function index(Request $request) {
       ...
       //dd($voucherTypeIdArray);   
        ...
        return view('accounting.vouchers.viewVouchers',['checkFirstLoad' => $checkFirstLoad,'projectSelected' => $projectSelected,'projectTypeSelected' => $projectTypeSelected,'branchSelected' => $branchSelected,'startDateSelected' => $startDateSelected,'endDateSelected' => $endDateSelected,'searchedVoucherTypeId' => $searchedVoucherTypeId,'user_branch_id' => $user_branch_id,'user_project_id' => $user_project_id,'user_project_type_id' => $user_project_type_id,'projects' => $projects,'branches' => $branches, 'projectTypes' => $projectTypes, 'voucherTypes' => $voucherTypes, 'vouchers' => $vouchers]);
