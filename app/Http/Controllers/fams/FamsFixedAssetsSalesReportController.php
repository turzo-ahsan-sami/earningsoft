...
class FamsFixedAssetsSalesReportController extends Controller
{
    ...
    $sales = DB::table('fams_sale')->whereIn('branchId',$branchId)
    ...
    //$sales =  DB::table('fams_sale')->get();
      ...
      $prefix = DB::table('fams_product_prefix')->where('status',1)->value('name');
       ...
       return view('fams/reports/view_fixed_assets_sales_report',['projects'=>$projects,'projectTypes'=>$projectTypes,'branches'=>$branches,'categories'=>$categories,'productTypes'=>$productTypes,'fiscalYears'=>$fiscalYears,'startDate'=>$startDate,'endDate'=>$endDate,'projectSelected'=>$projectSelected,'projectTypeSelected'=>$projectTypeSelected,'branchSelected'=>$branchSelected,'categorySelected'=>$categorySelected,'productTypeSelected'=>$productTypeSelected,'searchMethodSelected'=>$searchMethodSelected,'fiscalYearSelected'=>$fiscalYearSelected,'dateFromSelected'=>$dateFromSelected,'dateToSelected'=>$dateToSelected,'firstRequest'=>$firstRequest,'sales'=>$sales,'prefix'=>$prefix]);
    } 
