...
class InvStockQuantityReportController extends Controller
{
    public function index(){
    	$InvProducts = InvProduct::all();
    	return view('inventory/reports/stockQuantity/viewInvStockQuantityReport',['InvProducts' => $InvProducts]);
    }
    ...
    public function filterStockReport(Request $req){
		...
		return view('inventory/reports/stockQuantity/viewInvStockQuantityReport',['InvProducts' => $InvProducts, 'searchTypeCtr' => $searchTypeCtr, 'fiscalYearCtr' => $fiscalYearCtr]);
	}

		public function invBranchStockReport(){
    	$InvProducts = InvProduct::all();
    	return view('inventory/reports/stockQuantity/viewInvStockQuantityReportBranch',['InvProducts' => $InvProducts]);
    }
    ...
    public function filterStockReportBranch(Request $req){
		...
		return view('inventory/reports/stockQuantity/viewInvStockQuantityReportBranch',['InvProducts' => $InvProducts, 'searchTypeCtr' => $searchTypeCtr, 'fiscalYearCtr' => $fiscalYearCtr]);
	}
