...
use App\pos\InvBranchRequisition;
use App\pos\InvBranchRequisitionDetails;
use Validator;
use Response;
use DB;
use Carbon\Carbon;
...
class PosBranchRequisitionController extends Controller
{
    public function index(){
		...
		if($gnrBranchId==1){
			$requisitions = PosBranchRequisition::where('status', 1)->get();
      		return view('pos/transaction/branchRequisition/viewRequisition',['requisitions' => $requisitions]);
		}else{
    ...
    public function addInvBrnRequiF(){
      return view('pos/transaction/branchRequisition/addRequisition');
    }
