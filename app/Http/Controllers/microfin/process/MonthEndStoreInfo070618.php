    ...
    class MonthEndStoreInfo {
        ...
        public function storeLoanInfo(){
            ...
            $thisBranchLoans = DB::table('mfn_loan')
                                    ...
                                    ->select('id','productIdFk','memberIdFk','loanRepayPeriodIdFk','totalRepayAmount','loanAmount')
                                    ->get();
            ...
            foreach ($thisBranchLoans as $thisBranchLoan) {
                   ...
                   ///// new code to fetch regular, due, advance collection
                    ...
                    foreach ($currentLoanIds as $loanId) {
                        ...
                        // collection is equal or advance
                            ...
                            $regularCollection = $thisMonthCollectionAmount > $thisMonthPayableAmount  ? $thisMonthPayableAmount : $thisMonthCollectionAmount;
