...
public function posAddHrEmployee(){
    ...
    return view('microfin/employee/employeeList/addHrEmployee');
}
...
public function hrDetailsEmployee($employeeId) {
    ...
    return view('microfin/employee/employeeList/employeeDetails',['hrAllEmployeeDetails'=>$hrAllEmployeeDetails]);
