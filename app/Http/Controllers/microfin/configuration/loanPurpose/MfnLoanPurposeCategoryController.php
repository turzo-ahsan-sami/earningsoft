...
namespace App\Http\Controllers\microfin\configuration\loanPurpose;

use Illuminate\Http\Request;
use App\Http\Requests;
use App\microfin\configuration\MfnLoanPurposeCategory;
use Session;
use Validator;
use Response;
use DB;
...
class MfnLoanPurposeCategoryController extends controller {
	...
	public function index(){
		$data['pageTitle'] = 'New Loan Purpose Category';
		$data['addBtnLabel'] = 'New Loan Purpose Category';
		$data['addBtnUrl'] = url('createLoanPurposeCategory');

		$model = new MfnLoanPurposeCategory;
		$data['model'] = $model->orderby('name','asc')->paginate(env('PAGE_SIZE'));
		$data['attributes'] = $model->attributes();
		$data['easycode'] = $this->easycode;

		return view('microfin.configuration.loanPurpose.loanPurposeCategory.index',['model'=>$model,'data'=>$data]);
	}
