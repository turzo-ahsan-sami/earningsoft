...
class PksfPomisFiveReportController22012019 extends Controller {
    ...
    public function index() {
    	...
    	return view('microfin.reports.pksfPomisReport.pksfPomis5ReportOld.reportFilteringPart', $filteringArray);
    }
    ...
    public function getReport(Request $req){
        ...
        // dd('Total Execution Time for $cumSerChargeCollectionNON_PKSF: '.(microtime(true) - $time_start).' Sec');
        /// Total Others Income
        ...
        if ($req->filFund=='' || $req->filFund==null) {
            return view('microfin.reports.pksfPomisReport.pksfPomis5ReportOld.pksfPomisFiveReport',$data);
        }
        elseif ($req->filFund==1) {
            return view('microfin.reports.pksfPomisReport.pksfPomis5ReportOld.pksfPomisFiveReportPKSF',$data);
        }
        else{
            return view('microfin.reports.pksfPomisReport.pksfPomis5ReportOld.pksfPomisFiveReportNON_PKSF',$data);
        }
    }
