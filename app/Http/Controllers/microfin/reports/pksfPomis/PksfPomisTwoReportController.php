...
class PksfPomisTwoReportController extends Controller
{
	...
	public function index()
	{
		...
		return view('microfin.reports.pksfPomisReport.pksfPomis2Report.reportFilteringPart', $filteringArray);
	}
	...
	public function getReport(Request $req)
	{
		...
		// TO GET THE TOTAL BORROWER NUMBER WE NEED TO PUSH 0 AS A ACTIVE PRODUCT
		array_push($activeProductIds,0);
		...
		if ($req->filLoanOption == 1) {
			return view('microfin/reports/pksfPomisReport/pksfPomis2Report/pksfPomisTwoReportLoanProduct', $data);
		} else {
			return view('microfin.reports.pksfPomisReport.pksfPomis2Report.pksfPomisTwoReportLoanProductCategory', $data);
		}
	}
