...
class MraLlpSixReportController extends Controller {
    ...
    public function index() {
        ...
        return view('microfin.reports.mra.mraLlpSix.reportFilteringPart', $filteringArray);
    }
    ...
    public function getReport(Request $req){
        ...
        if ($req->filLoanOption==1) {
            return view('microfin.reports.mra.mraLlpSix.mraLlpSixReportLoanProduct',$data);
        }
        else{
            return view('microfin.reports.mra.mraLlpSix.mraLlpSixReportLoanProductCategory',$data);
        }
    }
