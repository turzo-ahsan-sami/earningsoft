      ...
      if ($RequestLoanAccount == 100) {
        if ($RequestFromDate == null and $RequestToDate == null){
          ...
          $MfnLoanTableInfo = DB::table('mfn_loan')
                              ->select('mfn_loans_product.name', 'mfn_loans_product.code', 'mfn_loan.loanCode', 'mfn_loan.disbursementDate', 'mfn_loan.loanAmount', 'mfn_loan.totalRepayAmount' , 'mfn_loan.id' , 'mfn_loan.memberIdFk')
                              ->join('mfn_loans_product', 'mfn_loan.productIdFk', '=', 'mfn_loans_product.id')
