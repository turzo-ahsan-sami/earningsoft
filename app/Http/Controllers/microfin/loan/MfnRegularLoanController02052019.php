	...
	public function __construct() {
		...
		*/
		public function addItem(Request $req) {
			...
			// dd($req->hasFile('memberSignatureImage'), $pRsImg);

			// dd('p1', $pImg, 'p2', $pRsImg, 'p3', $pNidImg, 'e1', $gImg, 'e2', $gRsImg, 'e3', $gNidImg);
			// dd($req);
			// dd($req->file('memberSignatureImage'));
			// dd($ok);
